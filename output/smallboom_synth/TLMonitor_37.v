module TLMonitor_37 (
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		if (reset) begin
			...
			_GEN_25 = {4100'h0, io_in_d_bits_source, 2'h0};
			_d_clr_T = 512'h1 << io_in_d_bits_source;
			_a_set_T = 512'h1 << io_in_a_bits_source;
			_d_opcodes_clr_T_5 = 4111'hf << _GEN_25;
			_a_opcodes_set_T_1 = {4095'h0, (_GEN ? {io_in_a_bits_opcode, 1'h1} : 4'h0)} << {4088'h0, io_in_a_bits_source, 2'h0};
			_d_sizes_clr_T_5 = 4111'hf << _GEN_25;
			_a_sizes_set_T_1 = {4095'h0, (_GEN ? {io_in_a_bits_size, 1'h1} : 3'h0)} << {4087'h0, io_in_a_bits_source, 2'h0};
			_GEN_24 = d_first_done & ~d_first_counter_1;
			a_first_counter <= (~a_first_done | (a_first_counter - 1'h1)) & a_first_counter;
			d_first_counter <= (~d_first_done | (d_first_counter - 1'h1)) & d_first_counter;
			inflight <= (inflight | (_GEN ? _a_set_T[335:0] : 336'h0)) & ~(_GEN_24 ? _d_clr_T[335:0] : 336'h0);
			inflight_opcodes <= (inflight_opcodes | (_GEN ? _a_opcodes_set_T_1[1343:0] : 1344'h0)) & ~(_GEN_24 ? _d_opcodes_clr_T_5[1343:0] : 1344'h0);
			inflight_sizes <= (inflight_sizes | (_GEN ? _a_sizes_set_T_1[1343:0] : 1344'h0)) & ~(_GEN_24 ? _d_sizes_clr_T_5[1343:0] : 1344'h0);
