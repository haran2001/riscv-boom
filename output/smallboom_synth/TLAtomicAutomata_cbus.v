module TLAtomicAutomata_cbus (
	...
	output wire [4:0] auto_out_a_bits_source;
	...
	wire _signext_a_T_13 = _GEN_1[1] | _signbit_a_T[0];
	wire [5:0] _GEN_3 = _signbit_d_T[6:1] | _signbit_d_T[5:0];
	wire [3:0] _GEN_4 = _GEN_3[5:2] | _GEN_3[3:0];
	wire _signext_d_T_13 = _GEN_3[1] | _signbit_d_T[0];
	...
	wire [63:0] a_a_ext = (cam_a_0_bits_data & wide_mask) | {{8 {_GEN_2[3] | _signext_a_T_13}}, {8 {_GEN_2[2] | _GEN_1[0]}}, {8 {_GEN_2[1] | _signbit_a_T[0]}}, {8 {_GEN_2[0]}}, {8 {_signext_a_T_13}}, {8 {_GEN_1[0]}}, {8 {_signbit_a_T[0]}}, 8'h00};
	wire [63:0] a_d_ext = (cam_d_0_data & wide_mask) | {{8 {_GEN_4[3] | _signext_d_T_13}}, {8 {_GEN_4[2] | _GEN_3[0]}}, {8 {_GEN_4[1] | _signbit_d_T[0]}}, {8 {_GEN_4[0]}}, {8 {_signext_d_T_13}}, {8 {_GEN_3[0]}}, {8 {_signbit_d_T[0]}}, 8'h00};
	...
	wire source_c_bits_a_mask_sub_sub_sub_0_1 = cam_a_0_bits_size > 4'h2;
	wire source_c_bits_a_mask_sub_sub_size = cam_a_0_bits_size[1:0] == 2'h2;
	wire source_c_bits_a_mask_sub_sub_0_1 = source_c_bits_a_mask_sub_sub_sub_0_1 | (source_c_bits_a_mask_sub_sub_size & ~cam_a_0_bits_address[2]);
	wire source_c_bits_a_mask_sub_sub_1_1 = source_c_bits_a_mask_sub_sub_sub_0_1 | (source_c_bits_a_mask_sub_sub_size & cam_a_0_bits_address[2]);
	wire source_c_bits_a_mask_sub_size = cam_a_0_bits_size[1:0] == 2'h1;
	wire source_c_bits_a_mask_sub_0_2 = ~cam_a_0_bits_address[2] & ~cam_a_0_bits_address[1];
	wire source_c_bits_a_mask_sub_0_1 = source_c_bits_a_mask_sub_sub_0_1 | (source_c_bits_a_mask_sub_size & source_c_bits_a_mask_sub_0_2);
	wire source_c_bits_a_mask_sub_1_2 = ~cam_a_0_bits_address[2] & cam_a_0_bits_address[1];
	wire source_c_bits_a_mask_sub_1_1 = source_c_bits_a_mask_sub_sub_0_1 | (source_c_bits_a_mask_sub_size & source_c_bits_a_mask_sub_1_2);
	wire source_c_bits_a_mask_sub_2_2 = cam_a_0_bits_address[2] & ~cam_a_0_bits_address[1];
	wire source_c_bits_a_mask_sub_2_1 = source_c_bits_a_mask_sub_sub_1_1 | (source_c_bits_a_mask_sub_size & source_c_bits_a_mask_sub_2_2);
	wire source_c_bits_a_mask_sub_3_2 = cam_a_0_bits_address[2] & cam_a_0_bits_address[1];
	wire source_c_bits_a_mask_sub_3_1 = source_c_bits_a_mask_sub_sub_1_1 | (source_c_bits_a_mask_sub_size & source_c_bits_a_mask_sub_3_2);
	reg [8:0] beatsLeft;
	...
	wire d_first = d_first_counter == 9'h000;
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		reg _d_first_T;
		reg _GEN_6;
		_GEN_5 = ((source_i_ready & source_i_valid) & ~a_isSupported) & cam_free_0;
		_d_first_T = nodeOut_d_ready & auto_out_d_valid;
		_GEN_6 = _d_first_T & d_first;
		if (reset) begin
			cam_s_0_state <= 2'h0;
			beatsLeft <= 9'h000;
			state_0 <= 1'h0;
			...
			if (_GEN_6 & d_cam_sel_0)
				...
				cam_s_0_state <= 2'h3;
			if (idle & auto_out_a_ready) begin : sv2v_autoblock_2
				reg [26:0] _decode_T;
				_decode_T = 27'h0000fff << auto_in_a_bits_size;
				beatsLeft <= (winner_1 & ~auto_in_a_bits_opcode[2] ? ~_decode_T[11:3] : 9'h000);
			end
			else
				beatsLeft <= beatsLeft - {8'h00, auto_out_a_ready & nodeOut_a_valid};
			if (idle) begin
				state_0 <= winner_0;
				state_1 <= winner_1;
			end
			if (_d_first_T) begin
				if (d_first) begin : sv2v_autoblock_3
					reg [26:0] _d_first_beats1_decode_T;
					_d_first_beats1_decode_T = 27'h0000fff << auto_out_d_bits_size;
					d_first_counter <= (auto_out_d_bits_opcode[0] ? ~_d_first_beats1_decode_T[11:3] : 9'h000);
				end
				else
					d_first_counter <= d_first_counter - 9'h001;
			end
		end
		if (_GEN_5) begin : sv2v_autoblock_4
			reg [15:0] _GEN_7;
			_GEN_7 = 16'hc8e6;
			...
			cam_a_0_lut <= _GEN_7[auto_in_a_bits_param[1:0] * 4+:4];
		end
