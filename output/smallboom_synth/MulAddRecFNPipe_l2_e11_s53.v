module MulAddRecFNPipe_l2_e11_s53 (
	...
	always @(posedge clock) begin
		if (io_validin) begin
			...
			mulAddRecFNToRaw_postMul_io_mulAddResult_pipe_b <= {1'h0, {53'h00000000000000, _mulAddRecFNToRaw_preMul_io_mulAddA} * {53'h00000000000000, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};
