module UniqueExeUnit (
	...
	io_csr_resp_bits_data,
	io_csr_resp_bits_addr,
	io_sfence_valid,
	io_sfence_bits_rs1,
	io_sfence_bits_rs2,
	io_sfence_bits_addr,
	...
	output wire io_ready_fu_types_4;
	output wire io_ready_fu_types_8;
	...
	output wire io_mul_resp_valid;
	output wire [7:0] io_mul_resp_bits_uop_br_mask;
	output wire [4:0] io_mul_resp_bits_uop_rob_idx;
	output wire [5:0] io_mul_resp_bits_uop_pdst;
	output wire [1:0] io_mul_resp_bits_uop_dst_rtype;
	output wire [63:0] io_mul_resp_bits_data;
	output wire io_csr_resp_valid;
	output wire [7:0] io_csr_resp_bits_uop_br_mask;
	output wire [4:0] io_csr_resp_bits_uop_rob_idx;
	output wire [5:0] io_csr_resp_bits_uop_pdst;
	output wire [2:0] io_csr_resp_bits_uop_csr_cmd;
	output wire [1:0] io_csr_resp_bits_uop_dst_rtype;
	output wire [63:0] io_csr_resp_bits_data;
	output wire [11:0] io_csr_resp_bits_addr;
	output wire io_sfence_valid;
	output wire io_sfence_bits_rs1;
	output wire io_sfence_bits_rs2;
	output wire [38:0] io_sfence_bits_addr;
	input io_ifpu_resp_ready;
	output wire io_ifpu_resp_valid;
	output wire [4:0] io_ifpu_resp_bits_uop_rob_idx;
	output wire [5:0] io_ifpu_resp_bits_uop_pdst;
	output wire [1:0] io_ifpu_resp_bits_uop_dst_rtype;
	output wire [64:0] io_ifpu_resp_bits_data;
	output wire io_ifpu_resp_bits_predicated;
	output wire io_ifpu_resp_bits_fflags_valid;
	output wire [4:0] io_ifpu_resp_bits_fflags_bits;
	input io_div_resp_ready;
	output wire io_div_resp_valid;
	output wire [7:0] io_div_resp_bits_uop_br_mask;
	output wire [4:0] io_div_resp_bits_uop_rob_idx;
	output wire [5:0] io_div_resp_bits_uop_pdst;
	output wire [1:0] io_div_resp_bits_uop_dst_rtype;
	output wire [63:0] io_div_resp_bits_data;
	wire _io_div_resp_div_ready_T;
	wire _io_div_resp_div_io_req_ready;
	wire _io_ifpu_resp_queue_io_enq_ready;
	wire [2:0] _io_ifpu_resp_queue_io_count;
	wire _io_ifpu_resp_ifpu_io_resp_valid;
	wire [31:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_inst;
	wire [31:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_debug_inst;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_rvc;
	wire [39:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_debug_pc;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_0;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_1;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_2;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_3;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_0;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_1;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_2;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_3;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_4;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_5;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_6;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_7;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_8;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_9;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_agen;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_dgen;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_speculative_child;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_speculative_child;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_bypass_hint;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_bypass_hint;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p3_bypass_hint;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_dis_col_sel;
	wire [7:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_br_mask;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_br_tag;
	wire [3:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_br_type;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfb;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_fence;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_fencei;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfence;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_amo;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_eret;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_sys_pc2epc;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_rocc;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_mov;
	wire [3:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_ftq_idx;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_edge_inst;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_pc_lob;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_taken;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_imm_rename;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_imm_sel;
	wire [4:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_pimm;
	wire [19:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_imm_packed;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_op1_sel;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_op2_sel;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ldst;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wen;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren1;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren2;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren3;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap12;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap23;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagIn;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagOut;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fromint;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_toint;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fastpipe;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fma;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_div;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_sqrt;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wflags;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_vec;
	wire [4:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_rob_idx;
	wire [3:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_ldq_idx;
	wire [3:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_stq_idx;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_rxq_idx;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_pdst;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_prs1;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_prs2;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_prs3;
	wire [3:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_ppred;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_prs1_busy;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_prs2_busy;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_prs3_busy;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_ppred_busy;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_stale_pdst;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_exception;
	wire [63:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_exc_cause;
	wire [4:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_mem_cmd;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_mem_size;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_mem_signed;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_uses_ldq;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_uses_stq;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_is_unique;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_flush_on_commit;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_csr_cmd;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_ldst_is_rs1;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_ldst;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_lrs1;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_lrs2;
	wire [5:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_lrs3;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_dst_rtype;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_lrs1_rtype;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_lrs2_rtype;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_frs3_en;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_dw;
	wire [4:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_op;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_val;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_rm;
	wire [1:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_fp_typ;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_pf_if;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ae_if;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ma_if;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_bp_debug_if;
	wire _io_ifpu_resp_ifpu_io_resp_bits_uop_bp_xcpt_if;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_debug_fsrc;
	wire [2:0] _io_ifpu_resp_ifpu_io_resp_bits_uop_debug_tsrc;
	wire [64:0] _io_ifpu_resp_ifpu_io_resp_bits_data;
	wire _io_ifpu_resp_ifpu_io_resp_bits_fflags_valid;
	wire [4:0] _io_ifpu_resp_ifpu_io_resp_bits_fflags_bits;
	wire _alu_io_resp_valid;
	wire [7:0] _alu_io_resp_bits_uop_br_mask;
	wire [4:0] _alu_io_resp_bits_uop_rob_idx;
	wire [5:0] _alu_io_resp_bits_uop_pdst;
	wire [2:0] _alu_io_resp_bits_uop_csr_cmd;
	...
	wire io_arb_irf_reqs_1_valid_0 = (arb_uop_valid & _arb_rebusied_prs2_T) & ~arb_uop_bits_iw_p2_bypass_hint;
	...
	wire _io_squash_iss_output = (io_arb_irf_reqs_0_valid_0 & ~io_arb_irf_reqs_0_ready) | (io_arb_irf_reqs_1_valid_0 & ~io_arb_irf_reqs_1_ready);
	reg c_valid_REG;
	reg [7:0] c_bits_uop_REG_br_mask;
	reg [4:0] c_bits_uop_REG_rob_idx;
	reg [5:0] c_bits_uop_REG_pdst;
	reg [2:0] c_bits_uop_REG_csr_cmd;
	reg [1:0] c_bits_uop_REG_dst_rtype;
	reg [63:0] c_bits_data_REG;
	reg [63:0] c_bits_addr_REG;
	reg s_valid_REG;
	reg s_bits_rs1_REG;
	reg s_bits_rs2_REG;
	reg [63:0] s_bits_addr_REG;
	reg io_ifpu_resp_ifpu_ready_REG;
	assign _io_div_resp_div_ready_T = exe_uop_valid & exe_uop_bits_fu_code_4;
	always @(posedge clock) begin : sv2v_autoblock_1
		reg [7:0] _will_replay_T;
		reg _arb_rebusied_prs2_T_1;
		reg arb_rebusied;
		reg [19:0] exe_imm_data_ip;
		reg _exe_imm_data_i4_1_T;
		reg _exe_imm_data_i11_T_1;
		reg _GEN;
		_arb_rebusied_prs2_T_1 = io_arb_rebusys_0_valid & io_arb_rebusys_0_bits_rebusy;
		...
		arb_rebusied = ((_arb_rebusied_prs1_T & _arb_rebusied_prs2_T_1) & (io_arb_rebusys_0_bits_uop_pdst == arb_uop_bits_prs1)) | ((_arb_rebusied_prs2_T & _arb_rebusied_prs2_T_1) & (io_arb_rebusys_0_bits_uop_pdst == arb_uop_bits_prs2));
		...
		arb_uop_bits_iw_issued_partial_agen <= _GEN & arb_uop_bits_iw_issued_partial_agen;
		arb_uop_bits_iw_issued_partial_dgen <= _GEN & arb_uop_bits_iw_issued_partial_dgen;
		...
		c_valid_REG <= _alu_io_resp_valid & |exe_uop_bits_csr_cmd;
		c_bits_uop_REG_br_mask <= _alu_io_resp_bits_uop_br_mask;
		c_bits_uop_REG_rob_idx <= _alu_io_resp_bits_uop_rob_idx;
		c_bits_uop_REG_pdst <= _alu_io_resp_bits_uop_pdst;
		c_bits_uop_REG_csr_cmd <= _alu_io_resp_bits_uop_csr_cmd;
		c_bits_uop_REG_dst_rtype <= _alu_io_resp_bits_uop_dst_rtype;
		c_bits_data_REG <= _alu_io_resp_bits_data;
		c_bits_addr_REG <= exe_imm_data;
		s_valid_REG <= exe_uop_valid & exe_uop_bits_is_sfence;
		s_bits_rs1_REG <= exe_uop_bits_pimm[0];
		s_bits_rs2_REG <= exe_uop_bits_pimm[1];
		s_bits_addr_REG <= exe_rs1_data;
		io_ifpu_resp_ifpu_ready_REG <= _io_ifpu_resp_queue_io_count < 3'h2;
	end
	PipelinedMulUnit io_mul_resp_imul(
		.clock(clock),
		.reset(reset),
		.io_kill(io_kill),
		.io_req_valid(exe_uop_valid & exe_uop_bits_fu_code_3),
	...
	ALUUnit alu(
		.io_req_valid(exe_uop_valid & exe_uop_bits_fu_code_5),
		...
		.io_req_bits_rs1_data(exe_rs1_data),
		.io_req_bits_rs2_data(exe_rs2_data),
		.io_req_bits_ftq_info_0_entry_cfi_idx_valid(1'h0),
		.io_req_bits_ftq_info_0_entry_cfi_idx_bits(2'h0),
		.io_req_bits_ftq_info_0_entry_start_bank(1'h0),
		.io_req_bits_ftq_info_0_pc(40'h0000000000),
		.io_req_bits_ftq_info_1_valid(1'h0),
		.io_req_bits_ftq_info_1_pc(40'h0000000000),
		.io_req_bits_pred_data(1'h0),
	...
	IntToFPUnit io_ifpu_resp_ifpu(
		.clock(clock),
		.reset(reset),
		.io_kill(io_kill),
		.io_req_valid(exe_uop_valid & exe_uop_bits_fu_code_8),
		...
		.io_req_bits_uop_fp_rm(exe_uop_bits_prs2[4:2]),
		.io_req_bits_uop_fp_typ(exe_uop_bits_prs2[1:0]),
		...
		.io_req_bits_rs1_data({1'h0, exe_rs1_data}),
		.io_resp_valid(_io_ifpu_resp_ifpu_io_resp_valid),
		.io_resp_bits_uop_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_inst),
		.io_resp_bits_uop_debug_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_inst),
		.io_resp_bits_uop_is_rvc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_rvc),
		.io_resp_bits_uop_debug_pc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_pc),
		.io_resp_bits_uop_iq_type_0(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_0),
		.io_resp_bits_uop_iq_type_1(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_1),
		.io_resp_bits_uop_iq_type_2(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_2),
		.io_resp_bits_uop_iq_type_3(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_3),
		.io_resp_bits_uop_fu_code_0(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_0),
		.io_resp_bits_uop_fu_code_1(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_1),
		.io_resp_bits_uop_fu_code_2(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_2),
		.io_resp_bits_uop_fu_code_3(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_3),
		.io_resp_bits_uop_fu_code_4(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_4),
		.io_resp_bits_uop_fu_code_5(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_5),
		.io_resp_bits_uop_fu_code_6(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_6),
		.io_resp_bits_uop_fu_code_7(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_7),
		.io_resp_bits_uop_fu_code_8(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_8),
		.io_resp_bits_uop_fu_code_9(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_9),
		.io_resp_bits_uop_iw_issued(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued),
		.io_resp_bits_uop_iw_issued_partial_agen(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_agen),
		.io_resp_bits_uop_iw_issued_partial_dgen(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_dgen),
		.io_resp_bits_uop_iw_p1_speculative_child(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_speculative_child),
		.io_resp_bits_uop_iw_p2_speculative_child(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_speculative_child),
		.io_resp_bits_uop_iw_p1_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_bypass_hint),
		.io_resp_bits_uop_iw_p2_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_bypass_hint),
		.io_resp_bits_uop_iw_p3_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p3_bypass_hint),
		.io_resp_bits_uop_dis_col_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_dis_col_sel),
		.io_resp_bits_uop_br_mask(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_mask),
		.io_resp_bits_uop_br_tag(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_tag),
		.io_resp_bits_uop_br_type(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_type),
		.io_resp_bits_uop_is_sfb(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfb),
		.io_resp_bits_uop_is_fence(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_fence),
		.io_resp_bits_uop_is_fencei(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_fencei),
		.io_resp_bits_uop_is_sfence(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfence),
		.io_resp_bits_uop_is_amo(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_amo),
		.io_resp_bits_uop_is_eret(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_eret),
		.io_resp_bits_uop_is_sys_pc2epc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sys_pc2epc),
		.io_resp_bits_uop_is_rocc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_rocc),
		.io_resp_bits_uop_is_mov(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_mov),
		.io_resp_bits_uop_ftq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_ftq_idx),
		.io_resp_bits_uop_edge_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_edge_inst),
		.io_resp_bits_uop_pc_lob(_io_ifpu_resp_ifpu_io_resp_bits_uop_pc_lob),
		.io_resp_bits_uop_taken(_io_ifpu_resp_ifpu_io_resp_bits_uop_taken),
		.io_resp_bits_uop_imm_rename(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_rename),
		.io_resp_bits_uop_imm_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_sel),
		.io_resp_bits_uop_pimm(_io_ifpu_resp_ifpu_io_resp_bits_uop_pimm),
		.io_resp_bits_uop_imm_packed(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_packed),
		.io_resp_bits_uop_op1_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_op1_sel),
		.io_resp_bits_uop_op2_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_op2_sel),
		.io_resp_bits_uop_fp_ctrl_ldst(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ldst),
		.io_resp_bits_uop_fp_ctrl_wen(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wen),
		.io_resp_bits_uop_fp_ctrl_ren1(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren1),
		.io_resp_bits_uop_fp_ctrl_ren2(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren2),
		.io_resp_bits_uop_fp_ctrl_ren3(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren3),
		.io_resp_bits_uop_fp_ctrl_swap12(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap12),
		.io_resp_bits_uop_fp_ctrl_swap23(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap23),
		.io_resp_bits_uop_fp_ctrl_typeTagIn(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagIn),
		.io_resp_bits_uop_fp_ctrl_typeTagOut(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagOut),
		.io_resp_bits_uop_fp_ctrl_fromint(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fromint),
		.io_resp_bits_uop_fp_ctrl_toint(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_toint),
		.io_resp_bits_uop_fp_ctrl_fastpipe(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fastpipe),
		.io_resp_bits_uop_fp_ctrl_fma(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fma),
		.io_resp_bits_uop_fp_ctrl_div(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_div),
		.io_resp_bits_uop_fp_ctrl_sqrt(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_sqrt),
		.io_resp_bits_uop_fp_ctrl_wflags(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wflags),
		.io_resp_bits_uop_fp_ctrl_vec(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_vec),
		.io_resp_bits_uop_rob_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_rob_idx),
		.io_resp_bits_uop_ldq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_ldq_idx),
		.io_resp_bits_uop_stq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_stq_idx),
		.io_resp_bits_uop_rxq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_rxq_idx),
		...
		.io_resp_bits_uop_prs1_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs1_busy),
		.io_resp_bits_uop_prs2_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs2_busy),
		.io_resp_bits_uop_prs3_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs3_busy),
		.io_resp_bits_uop_ppred_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_ppred_busy),
		.io_resp_bits_uop_stale_pdst(_io_ifpu_resp_ifpu_io_resp_bits_uop_stale_pdst),
		.io_resp_bits_uop_exception(_io_ifpu_resp_ifpu_io_resp_bits_uop_exception),
		.io_resp_bits_uop_exc_cause(_io_ifpu_resp_ifpu_io_resp_bits_uop_exc_cause),
		.io_resp_bits_uop_mem_cmd(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_cmd),
		.io_resp_bits_uop_mem_size(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_size),
		.io_resp_bits_uop_mem_signed(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_signed),
		.io_resp_bits_uop_uses_ldq(_io_ifpu_resp_ifpu_io_resp_bits_uop_uses_ldq),
		.io_resp_bits_uop_uses_stq(_io_ifpu_resp_ifpu_io_resp_bits_uop_uses_stq),
		.io_resp_bits_uop_is_unique(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_unique),
		.io_resp_bits_uop_flush_on_commit(_io_ifpu_resp_ifpu_io_resp_bits_uop_flush_on_commit),
		.io_resp_bits_uop_csr_cmd(_io_ifpu_resp_ifpu_io_resp_bits_uop_csr_cmd),
		.io_resp_bits_uop_ldst_is_rs1(_io_ifpu_resp_ifpu_io_resp_bits_uop_ldst_is_rs1),
		...
		.io_resp_bits_uop_dst_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_dst_rtype),
		.io_resp_bits_uop_lrs1_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs1_rtype),
		.io_resp_bits_uop_lrs2_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs2_rtype),
		.io_resp_bits_uop_frs3_en(_io_ifpu_resp_ifpu_io_resp_bits_uop_frs3_en),
		.io_resp_bits_uop_fcn_dw(_io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_dw),
		.io_resp_bits_uop_fcn_op(_io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_op),
		.io_resp_bits_uop_fp_val(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_val),
		.io_resp_bits_uop_fp_rm(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_rm),
		.io_resp_bits_uop_fp_typ(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_typ),
		.io_resp_bits_uop_xcpt_pf_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_pf_if),
		.io_resp_bits_uop_xcpt_ae_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ae_if),
		.io_resp_bits_uop_xcpt_ma_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ma_if),
		.io_resp_bits_uop_bp_debug_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_bp_debug_if),
		.io_resp_bits_uop_bp_xcpt_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_bp_xcpt_if),
		.io_resp_bits_uop_debug_fsrc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_fsrc),
		.io_resp_bits_uop_debug_tsrc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_tsrc),
		.io_resp_bits_data(_io_ifpu_resp_ifpu_io_resp_bits_data),
		.io_resp_bits_fflags_valid(_io_ifpu_resp_ifpu_io_resp_bits_fflags_valid),
		.io_resp_bits_fflags_bits(_io_ifpu_resp_ifpu_io_resp_bits_fflags_bits),
		.io_brupdate_b1_resolve_mask(io_brupdate_b1_resolve_mask),
		.io_brupdate_b1_mispredict_mask(io_brupdate_b1_mispredict_mask),
		.io_fcsr_rm(io_fcsr_rm)
	);
	BranchKillableQueue_5 io_ifpu_resp_queue(
		.clock(clock),
		.reset(reset),
		.io_enq_ready(_io_ifpu_resp_queue_io_enq_ready),
		.io_enq_valid(_io_ifpu_resp_ifpu_io_resp_valid),
		.io_enq_bits_uop_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_inst),
		.io_enq_bits_uop_debug_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_inst),
		.io_enq_bits_uop_is_rvc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_rvc),
		.io_enq_bits_uop_debug_pc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_pc),
		.io_enq_bits_uop_iq_type_0(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_0),
		.io_enq_bits_uop_iq_type_1(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_1),
		.io_enq_bits_uop_iq_type_2(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_2),
		.io_enq_bits_uop_iq_type_3(_io_ifpu_resp_ifpu_io_resp_bits_uop_iq_type_3),
		.io_enq_bits_uop_fu_code_0(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_0),
		.io_enq_bits_uop_fu_code_1(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_1),
		.io_enq_bits_uop_fu_code_2(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_2),
		.io_enq_bits_uop_fu_code_3(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_3),
		.io_enq_bits_uop_fu_code_4(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_4),
		.io_enq_bits_uop_fu_code_5(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_5),
		.io_enq_bits_uop_fu_code_6(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_6),
		.io_enq_bits_uop_fu_code_7(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_7),
		.io_enq_bits_uop_fu_code_8(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_8),
		.io_enq_bits_uop_fu_code_9(_io_ifpu_resp_ifpu_io_resp_bits_uop_fu_code_9),
		.io_enq_bits_uop_iw_issued(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued),
		.io_enq_bits_uop_iw_issued_partial_agen(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_agen),
		.io_enq_bits_uop_iw_issued_partial_dgen(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_issued_partial_dgen),
		.io_enq_bits_uop_iw_p1_speculative_child(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_speculative_child),
		.io_enq_bits_uop_iw_p2_speculative_child(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_speculative_child),
		.io_enq_bits_uop_iw_p1_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p1_bypass_hint),
		.io_enq_bits_uop_iw_p2_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p2_bypass_hint),
		.io_enq_bits_uop_iw_p3_bypass_hint(_io_ifpu_resp_ifpu_io_resp_bits_uop_iw_p3_bypass_hint),
		.io_enq_bits_uop_dis_col_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_dis_col_sel),
		.io_enq_bits_uop_br_mask(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_mask),
		.io_enq_bits_uop_br_tag(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_tag),
		.io_enq_bits_uop_br_type(_io_ifpu_resp_ifpu_io_resp_bits_uop_br_type),
		.io_enq_bits_uop_is_sfb(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfb),
		.io_enq_bits_uop_is_fence(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_fence),
		.io_enq_bits_uop_is_fencei(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_fencei),
		.io_enq_bits_uop_is_sfence(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sfence),
		.io_enq_bits_uop_is_amo(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_amo),
		.io_enq_bits_uop_is_eret(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_eret),
		.io_enq_bits_uop_is_sys_pc2epc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_sys_pc2epc),
		.io_enq_bits_uop_is_rocc(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_rocc),
		.io_enq_bits_uop_is_mov(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_mov),
		.io_enq_bits_uop_ftq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_ftq_idx),
		.io_enq_bits_uop_edge_inst(_io_ifpu_resp_ifpu_io_resp_bits_uop_edge_inst),
		.io_enq_bits_uop_pc_lob(_io_ifpu_resp_ifpu_io_resp_bits_uop_pc_lob),
		.io_enq_bits_uop_taken(_io_ifpu_resp_ifpu_io_resp_bits_uop_taken),
		.io_enq_bits_uop_imm_rename(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_rename),
		.io_enq_bits_uop_imm_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_sel),
		.io_enq_bits_uop_pimm(_io_ifpu_resp_ifpu_io_resp_bits_uop_pimm),
		.io_enq_bits_uop_imm_packed(_io_ifpu_resp_ifpu_io_resp_bits_uop_imm_packed),
		.io_enq_bits_uop_op1_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_op1_sel),
		.io_enq_bits_uop_op2_sel(_io_ifpu_resp_ifpu_io_resp_bits_uop_op2_sel),
		.io_enq_bits_uop_fp_ctrl_ldst(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ldst),
		.io_enq_bits_uop_fp_ctrl_wen(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wen),
		.io_enq_bits_uop_fp_ctrl_ren1(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren1),
		.io_enq_bits_uop_fp_ctrl_ren2(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren2),
		.io_enq_bits_uop_fp_ctrl_ren3(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_ren3),
		.io_enq_bits_uop_fp_ctrl_swap12(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap12),
		.io_enq_bits_uop_fp_ctrl_swap23(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_swap23),
		.io_enq_bits_uop_fp_ctrl_typeTagIn(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagIn),
		.io_enq_bits_uop_fp_ctrl_typeTagOut(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_typeTagOut),
		.io_enq_bits_uop_fp_ctrl_fromint(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fromint),
		.io_enq_bits_uop_fp_ctrl_toint(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_toint),
		.io_enq_bits_uop_fp_ctrl_fastpipe(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fastpipe),
		.io_enq_bits_uop_fp_ctrl_fma(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_fma),
		.io_enq_bits_uop_fp_ctrl_div(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_div),
		.io_enq_bits_uop_fp_ctrl_sqrt(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_sqrt),
		.io_enq_bits_uop_fp_ctrl_wflags(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_wflags),
		.io_enq_bits_uop_fp_ctrl_vec(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_ctrl_vec),
		.io_enq_bits_uop_rob_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_rob_idx),
		.io_enq_bits_uop_ldq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_ldq_idx),
		.io_enq_bits_uop_stq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_stq_idx),
		.io_enq_bits_uop_rxq_idx(_io_ifpu_resp_ifpu_io_resp_bits_uop_rxq_idx),
		.io_enq_bits_uop_pdst(_io_ifpu_resp_ifpu_io_resp_bits_uop_pdst),
		.io_enq_bits_uop_prs1(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs1),
		.io_enq_bits_uop_prs2(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs2),
		.io_enq_bits_uop_prs3(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs3),
		.io_enq_bits_uop_ppred(_io_ifpu_resp_ifpu_io_resp_bits_uop_ppred),
		.io_enq_bits_uop_prs1_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs1_busy),
		.io_enq_bits_uop_prs2_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs2_busy),
		.io_enq_bits_uop_prs3_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_prs3_busy),
		.io_enq_bits_uop_ppred_busy(_io_ifpu_resp_ifpu_io_resp_bits_uop_ppred_busy),
		.io_enq_bits_uop_stale_pdst(_io_ifpu_resp_ifpu_io_resp_bits_uop_stale_pdst),
		.io_enq_bits_uop_exception(_io_ifpu_resp_ifpu_io_resp_bits_uop_exception),
		.io_enq_bits_uop_exc_cause(_io_ifpu_resp_ifpu_io_resp_bits_uop_exc_cause),
		.io_enq_bits_uop_mem_cmd(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_cmd),
		.io_enq_bits_uop_mem_size(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_size),
		.io_enq_bits_uop_mem_signed(_io_ifpu_resp_ifpu_io_resp_bits_uop_mem_signed),
		.io_enq_bits_uop_uses_ldq(_io_ifpu_resp_ifpu_io_resp_bits_uop_uses_ldq),
		.io_enq_bits_uop_uses_stq(_io_ifpu_resp_ifpu_io_resp_bits_uop_uses_stq),
		.io_enq_bits_uop_is_unique(_io_ifpu_resp_ifpu_io_resp_bits_uop_is_unique),
		.io_enq_bits_uop_flush_on_commit(_io_ifpu_resp_ifpu_io_resp_bits_uop_flush_on_commit),
		.io_enq_bits_uop_csr_cmd(_io_ifpu_resp_ifpu_io_resp_bits_uop_csr_cmd),
		.io_enq_bits_uop_ldst_is_rs1(_io_ifpu_resp_ifpu_io_resp_bits_uop_ldst_is_rs1),
		.io_enq_bits_uop_ldst(_io_ifpu_resp_ifpu_io_resp_bits_uop_ldst),
		.io_enq_bits_uop_lrs1(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs1),
		.io_enq_bits_uop_lrs2(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs2),
		.io_enq_bits_uop_lrs3(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs3),
		.io_enq_bits_uop_dst_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_dst_rtype),
		.io_enq_bits_uop_lrs1_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs1_rtype),
		.io_enq_bits_uop_lrs2_rtype(_io_ifpu_resp_ifpu_io_resp_bits_uop_lrs2_rtype),
		.io_enq_bits_uop_frs3_en(_io_ifpu_resp_ifpu_io_resp_bits_uop_frs3_en),
		.io_enq_bits_uop_fcn_dw(_io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_dw),
		.io_enq_bits_uop_fcn_op(_io_ifpu_resp_ifpu_io_resp_bits_uop_fcn_op),
		.io_enq_bits_uop_fp_val(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_val),
		.io_enq_bits_uop_fp_rm(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_rm),
		.io_enq_bits_uop_fp_typ(_io_ifpu_resp_ifpu_io_resp_bits_uop_fp_typ),
		.io_enq_bits_uop_xcpt_pf_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_pf_if),
		.io_enq_bits_uop_xcpt_ae_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ae_if),
		.io_enq_bits_uop_xcpt_ma_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_xcpt_ma_if),
		.io_enq_bits_uop_bp_debug_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_bp_debug_if),
		.io_enq_bits_uop_bp_xcpt_if(_io_ifpu_resp_ifpu_io_resp_bits_uop_bp_xcpt_if),
		.io_enq_bits_uop_debug_fsrc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_fsrc),
		.io_enq_bits_uop_debug_tsrc(_io_ifpu_resp_ifpu_io_resp_bits_uop_debug_tsrc),
		.io_enq_bits_data(_io_ifpu_resp_ifpu_io_resp_bits_data),
		.io_enq_bits_fflags_valid(_io_ifpu_resp_ifpu_io_resp_bits_fflags_valid),
		.io_enq_bits_fflags_bits(_io_ifpu_resp_ifpu_io_resp_bits_fflags_bits),
	...
	DivUnit io_div_resp_div(
		.clock(clock),
		.reset(reset),
		.io_kill(io_kill),
		.io_req_ready(_io_div_resp_div_io_req_ready),
		.io_req_valid(_io_div_resp_div_ready_T),
		.io_req_bits_uop_br_mask(exe_uop_bits_br_mask),
		.io_req_bits_uop_rob_idx(exe_uop_bits_rob_idx),
		.io_req_bits_uop_pdst(exe_uop_bits_pdst),
		.io_req_bits_uop_dst_rtype(exe_uop_bits_dst_rtype),
	...
	assign io_ready_fu_types_4 = ((_io_div_resp_div_io_req_ready & ~_io_div_resp_div_ready_T) & ~(rrd_uop_valid & rrd_uop_bits_fu_code_4)) & ~(arb_uop_valid & arb_uop_bits_fu_code_4);
	assign io_ready_fu_types_8 = io_ifpu_resp_ifpu_ready_REG;
	assign io_arb_irf_reqs_0_valid = io_arb_irf_reqs_0_valid_0;
	assign io_arb_irf_reqs_0_bits = arb_uop_bits_prs1;
	assign io_arb_irf_reqs_1_valid = io_arb_irf_reqs_1_valid_0;
	...
	assign io_csr_resp_valid = c_valid_REG;
	assign io_csr_resp_bits_uop_br_mask = c_bits_uop_REG_br_mask;
	assign io_csr_resp_bits_uop_rob_idx = c_bits_uop_REG_rob_idx;
	assign io_csr_resp_bits_uop_pdst = c_bits_uop_REG_pdst;
	assign io_csr_resp_bits_uop_csr_cmd = c_bits_uop_REG_csr_cmd;
	assign io_csr_resp_bits_uop_dst_rtype = c_bits_uop_REG_dst_rtype;
	assign io_csr_resp_bits_data = c_bits_data_REG;
	assign io_csr_resp_bits_addr = c_bits_addr_REG[11:0];
	assign io_sfence_valid = s_valid_REG;
	assign io_sfence_bits_rs1 = s_bits_rs1_REG;
	assign io_sfence_bits_rs2 = s_bits_rs2_REG;
	assign io_sfence_bits_addr = s_bits_addr_REG[38:0];
endmodule
