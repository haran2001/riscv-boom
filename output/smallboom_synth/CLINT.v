module CLINT (
	...
	wire _out_T_5 = auto_in_a_bits_address[13:3] == 11'h000;
	...
	wire [3:0] _GEN = {1'h1, &auto_in_a_bits_address[13:3], _out_T_5, _out_T_5};
	wire [255:0] _GEN_0 = {64'h0000000000000000, time_0, pad, 63'h0000000000000000, ipi_0};
	wire [2:0] nodeIn_d_bits_opcode = {2'h0, in_bits_read};
	always @(posedge clock) begin
		if (reset) begin
			time_0 <= 64'h0000000000000000;
			ipi_0 <= 1'h0;
		end
		else begin
			if (((((((valids_1_0 | valids_1_1) | valids_1_2) | valids_1_3) | valids_1_4) | valids_1_5) | valids_1_6) | valids_1_7)
				...
				time_0 <= time_0 + 64'h0000000000000001;
	...
	assign auto_in_d_bits_data = (_GEN[auto_in_a_bits_address[15:14]] ? _GEN_0[auto_in_a_bits_address[15:14] * 64+:64] : 64'h0000000000000000);
endmodule
