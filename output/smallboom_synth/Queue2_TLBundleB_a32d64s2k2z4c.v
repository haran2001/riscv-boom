module Queue2_TLBundleB_a32d64s2k2z4c (
	...
	output wire [1:0] io_deq_bits_source;
	...
	ram_2x52 ram_ext(
		...
		.W0_en(do_enq),
		.W0_clk(clock),
		.W0_data({io_enq_bits_corrupt, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})
	);
