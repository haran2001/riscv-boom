module TageTable (
	...
	wire [43:0] _tage_table_2_ext_R0_data;
	wire [7:0] _tage_u_2_ext_R0_data;
	reg doing_reset;
	reg [6:0] reset_idx;
	...
	assign s2_req_rtage_0_tag = _tage_table_2_ext_R0_data[9:3];
	assign s2_req_rtage_0_valid = _tage_table_2_ext_R0_data[10];
	assign s2_req_rtage_1_tag = _tage_table_2_ext_R0_data[20:14];
	assign s2_req_rtage_1_valid = _tage_table_2_ext_R0_data[21];
	assign s2_req_rtage_2_tag = _tage_table_2_ext_R0_data[31:25];
	assign s2_req_rtage_2_valid = _tage_table_2_ext_R0_data[32];
	assign s2_req_rtage_3_tag = _tage_table_2_ext_R0_data[42:36];
	assign s2_req_rtage_3_valid = _tage_table_2_ext_R0_data[43];
	assign wdata_0 = (doing_reset ? 11'h000 : {1'h1, io_update_pc[16:12], _GEN_0, update_wdata_0_ctr});
	assign wdata_1 = (doing_reset ? 11'h000 : {1'h1, io_update_pc[16:12], _GEN_0, update_wdata_1_ctr});
	assign wdata_2 = (doing_reset ? 11'h000 : {1'h1, io_update_pc[16:12], _GEN_0, update_wdata_2_ctr});
	assign wdata_3 = (doing_reset ? 11'h000 : {1'h1, io_update_pc[16:12], _GEN_0, update_wdata_3_ctr});
	...
	tage_u_128x8 tage_u_2_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_u_2_ext_R0_data),
		.W0_addr((doing_reset ? reset_idx : (doing_clear_u ? clear_u_ctr[17:11] : {io_update_pc[9:5], _GEN}))),
	...
	tage_table_128x44 tage_table_2_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_table_2_ext_R0_data),
	...
	assign io_f2_resp_0_bits_ctr = _tage_table_2_ext_R0_data[2:0];
	assign io_f2_resp_0_bits_u = _tage_u_2_ext_R0_data[1:0];
	assign io_f2_resp_1_valid = (s2_req_rtage_1_valid & (s2_req_rtage_1_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_1_bits_ctr = _tage_table_2_ext_R0_data[13:11];
	assign io_f2_resp_1_bits_u = _tage_u_2_ext_R0_data[3:2];
	assign io_f2_resp_2_valid = (s2_req_rtage_2_valid & (s2_req_rtage_2_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_2_bits_ctr = _tage_table_2_ext_R0_data[24:22];
	assign io_f2_resp_2_bits_u = _tage_u_2_ext_R0_data[5:4];
	assign io_f2_resp_3_valid = (s2_req_rtage_3_valid & (s2_req_rtage_3_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_3_bits_ctr = _tage_table_2_ext_R0_data[35:33];
	assign io_f2_resp_3_bits_u = _tage_u_2_ext_R0_data[7:6];
endmodule
