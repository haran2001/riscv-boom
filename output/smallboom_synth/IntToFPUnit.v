module IntToFPUnit (
	...
	always @(posedge clock) begin
		...
		if (io_req_valid)
			out_double_pipe_b <= io_req_bits_uop_fp_ctrl_typeTagOut == 2'h1;
		if (out_double_pipe_v)
			out_double_pipe_pipe_b <= out_double_pipe_b;
	end
	BranchKillablePipeline_1 pipe(
		.clock(clock),
		.reset(reset),
		...
		.io_resp_1_valid(_pipe_io_resp_1_valid),
		.io_resp_1_bits_uop_inst(io_resp_bits_uop_inst),
		.io_resp_1_bits_uop_debug_inst(io_resp_bits_uop_debug_inst),
		.io_resp_1_bits_uop_is_rvc(io_resp_bits_uop_is_rvc),
		.io_resp_1_bits_uop_debug_pc(io_resp_bits_uop_debug_pc),
		.io_resp_1_bits_uop_iq_type_0(io_resp_bits_uop_iq_type_0),
		.io_resp_1_bits_uop_iq_type_1(io_resp_bits_uop_iq_type_1),
		.io_resp_1_bits_uop_iq_type_2(io_resp_bits_uop_iq_type_2),
		.io_resp_1_bits_uop_iq_type_3(io_resp_bits_uop_iq_type_3),
		.io_resp_1_bits_uop_fu_code_0(io_resp_bits_uop_fu_code_0),
		.io_resp_1_bits_uop_fu_code_1(io_resp_bits_uop_fu_code_1),
		.io_resp_1_bits_uop_fu_code_2(io_resp_bits_uop_fu_code_2),
		.io_resp_1_bits_uop_fu_code_3(io_resp_bits_uop_fu_code_3),
		.io_resp_1_bits_uop_fu_code_4(io_resp_bits_uop_fu_code_4),
		.io_resp_1_bits_uop_fu_code_5(io_resp_bits_uop_fu_code_5),
		.io_resp_1_bits_uop_fu_code_6(io_resp_bits_uop_fu_code_6),
		.io_resp_1_bits_uop_fu_code_7(io_resp_bits_uop_fu_code_7),
		.io_resp_1_bits_uop_fu_code_8(io_resp_bits_uop_fu_code_8),
		.io_resp_1_bits_uop_fu_code_9(io_resp_bits_uop_fu_code_9),
		.io_resp_1_bits_uop_iw_issued(io_resp_bits_uop_iw_issued),
		.io_resp_1_bits_uop_iw_issued_partial_agen(io_resp_bits_uop_iw_issued_partial_agen),
		.io_resp_1_bits_uop_iw_issued_partial_dgen(io_resp_bits_uop_iw_issued_partial_dgen),
		.io_resp_1_bits_uop_iw_p1_speculative_child(io_resp_bits_uop_iw_p1_speculative_child),
		.io_resp_1_bits_uop_iw_p2_speculative_child(io_resp_bits_uop_iw_p2_speculative_child),
		.io_resp_1_bits_uop_iw_p1_bypass_hint(io_resp_bits_uop_iw_p1_bypass_hint),
		.io_resp_1_bits_uop_iw_p2_bypass_hint(io_resp_bits_uop_iw_p2_bypass_hint),
		.io_resp_1_bits_uop_iw_p3_bypass_hint(io_resp_bits_uop_iw_p3_bypass_hint),
		.io_resp_1_bits_uop_dis_col_sel(io_resp_bits_uop_dis_col_sel),
		.io_resp_1_bits_uop_br_mask(io_resp_bits_uop_br_mask),
		.io_resp_1_bits_uop_br_tag(io_resp_bits_uop_br_tag),
		.io_resp_1_bits_uop_br_type(io_resp_bits_uop_br_type),
		.io_resp_1_bits_uop_is_sfb(io_resp_bits_uop_is_sfb),
		.io_resp_1_bits_uop_is_fence(io_resp_bits_uop_is_fence),
		.io_resp_1_bits_uop_is_fencei(io_resp_bits_uop_is_fencei),
		.io_resp_1_bits_uop_is_sfence(io_resp_bits_uop_is_sfence),
		.io_resp_1_bits_uop_is_amo(io_resp_bits_uop_is_amo),
		.io_resp_1_bits_uop_is_eret(io_resp_bits_uop_is_eret),
		.io_resp_1_bits_uop_is_sys_pc2epc(io_resp_bits_uop_is_sys_pc2epc),
		.io_resp_1_bits_uop_is_rocc(io_resp_bits_uop_is_rocc),
		.io_resp_1_bits_uop_is_mov(io_resp_bits_uop_is_mov),
		.io_resp_1_bits_uop_ftq_idx(io_resp_bits_uop_ftq_idx),
		.io_resp_1_bits_uop_edge_inst(io_resp_bits_uop_edge_inst),
		.io_resp_1_bits_uop_pc_lob(io_resp_bits_uop_pc_lob),
		.io_resp_1_bits_uop_taken(io_resp_bits_uop_taken),
		.io_resp_1_bits_uop_imm_rename(io_resp_bits_uop_imm_rename),
		.io_resp_1_bits_uop_imm_sel(io_resp_bits_uop_imm_sel),
		.io_resp_1_bits_uop_pimm(io_resp_bits_uop_pimm),
		.io_resp_1_bits_uop_imm_packed(io_resp_bits_uop_imm_packed),
		.io_resp_1_bits_uop_op1_sel(io_resp_bits_uop_op1_sel),
		.io_resp_1_bits_uop_op2_sel(io_resp_bits_uop_op2_sel),
		.io_resp_1_bits_uop_fp_ctrl_ldst(io_resp_bits_uop_fp_ctrl_ldst),
		.io_resp_1_bits_uop_fp_ctrl_wen(io_resp_bits_uop_fp_ctrl_wen),
		.io_resp_1_bits_uop_fp_ctrl_ren1(io_resp_bits_uop_fp_ctrl_ren1),
		.io_resp_1_bits_uop_fp_ctrl_ren2(io_resp_bits_uop_fp_ctrl_ren2),
		.io_resp_1_bits_uop_fp_ctrl_ren3(io_resp_bits_uop_fp_ctrl_ren3),
		.io_resp_1_bits_uop_fp_ctrl_swap12(io_resp_bits_uop_fp_ctrl_swap12),
		.io_resp_1_bits_uop_fp_ctrl_swap23(io_resp_bits_uop_fp_ctrl_swap23),
		.io_resp_1_bits_uop_fp_ctrl_typeTagIn(io_resp_bits_uop_fp_ctrl_typeTagIn),
		.io_resp_1_bits_uop_fp_ctrl_typeTagOut(io_resp_bits_uop_fp_ctrl_typeTagOut),
		.io_resp_1_bits_uop_fp_ctrl_fromint(io_resp_bits_uop_fp_ctrl_fromint),
		.io_resp_1_bits_uop_fp_ctrl_toint(io_resp_bits_uop_fp_ctrl_toint),
		.io_resp_1_bits_uop_fp_ctrl_fastpipe(io_resp_bits_uop_fp_ctrl_fastpipe),
		.io_resp_1_bits_uop_fp_ctrl_fma(io_resp_bits_uop_fp_ctrl_fma),
		.io_resp_1_bits_uop_fp_ctrl_div(io_resp_bits_uop_fp_ctrl_div),
		.io_resp_1_bits_uop_fp_ctrl_sqrt(io_resp_bits_uop_fp_ctrl_sqrt),
		.io_resp_1_bits_uop_fp_ctrl_wflags(io_resp_bits_uop_fp_ctrl_wflags),
		.io_resp_1_bits_uop_fp_ctrl_vec(io_resp_bits_uop_fp_ctrl_vec),
		.io_resp_1_bits_uop_rob_idx(io_resp_bits_uop_rob_idx),
		.io_resp_1_bits_uop_ldq_idx(io_resp_bits_uop_ldq_idx),
		.io_resp_1_bits_uop_stq_idx(io_resp_bits_uop_stq_idx),
		.io_resp_1_bits_uop_rxq_idx(io_resp_bits_uop_rxq_idx),
		.io_resp_1_bits_uop_pdst(io_resp_bits_uop_pdst),
		.io_resp_1_bits_uop_prs1(io_resp_bits_uop_prs1),
		.io_resp_1_bits_uop_prs2(io_resp_bits_uop_prs2),
		.io_resp_1_bits_uop_prs3(io_resp_bits_uop_prs3),
		.io_resp_1_bits_uop_ppred(io_resp_bits_uop_ppred),
		.io_resp_1_bits_uop_prs1_busy(io_resp_bits_uop_prs1_busy),
		.io_resp_1_bits_uop_prs2_busy(io_resp_bits_uop_prs2_busy),
		.io_resp_1_bits_uop_prs3_busy(io_resp_bits_uop_prs3_busy),
		.io_resp_1_bits_uop_ppred_busy(io_resp_bits_uop_ppred_busy),
		.io_resp_1_bits_uop_stale_pdst(io_resp_bits_uop_stale_pdst),
		.io_resp_1_bits_uop_exception(io_resp_bits_uop_exception),
		.io_resp_1_bits_uop_exc_cause(io_resp_bits_uop_exc_cause),
		.io_resp_1_bits_uop_mem_cmd(io_resp_bits_uop_mem_cmd),
		.io_resp_1_bits_uop_mem_size(io_resp_bits_uop_mem_size),
		.io_resp_1_bits_uop_mem_signed(io_resp_bits_uop_mem_signed),
		.io_resp_1_bits_uop_uses_ldq(io_resp_bits_uop_uses_ldq),
		.io_resp_1_bits_uop_uses_stq(io_resp_bits_uop_uses_stq),
		.io_resp_1_bits_uop_is_unique(io_resp_bits_uop_is_unique),
		.io_resp_1_bits_uop_flush_on_commit(io_resp_bits_uop_flush_on_commit),
		.io_resp_1_bits_uop_csr_cmd(io_resp_bits_uop_csr_cmd),
		.io_resp_1_bits_uop_ldst_is_rs1(io_resp_bits_uop_ldst_is_rs1),
		.io_resp_1_bits_uop_ldst(io_resp_bits_uop_ldst),
		.io_resp_1_bits_uop_lrs1(io_resp_bits_uop_lrs1),
		.io_resp_1_bits_uop_lrs2(io_resp_bits_uop_lrs2),
		.io_resp_1_bits_uop_lrs3(io_resp_bits_uop_lrs3),
		.io_resp_1_bits_uop_dst_rtype(io_resp_bits_uop_dst_rtype),
		.io_resp_1_bits_uop_lrs1_rtype(io_resp_bits_uop_lrs1_rtype),
		.io_resp_1_bits_uop_lrs2_rtype(io_resp_bits_uop_lrs2_rtype),
		.io_resp_1_bits_uop_frs3_en(io_resp_bits_uop_frs3_en),
		.io_resp_1_bits_uop_fcn_dw(io_resp_bits_uop_fcn_dw),
		.io_resp_1_bits_uop_fcn_op(io_resp_bits_uop_fcn_op),
		.io_resp_1_bits_uop_fp_val(io_resp_bits_uop_fp_val),
		.io_resp_1_bits_uop_fp_rm(io_resp_bits_uop_fp_rm),
		.io_resp_1_bits_uop_fp_typ(io_resp_bits_uop_fp_typ),
		.io_resp_1_bits_uop_xcpt_pf_if(io_resp_bits_uop_xcpt_pf_if),
		.io_resp_1_bits_uop_xcpt_ae_if(io_resp_bits_uop_xcpt_ae_if),
		.io_resp_1_bits_uop_xcpt_ma_if(io_resp_bits_uop_xcpt_ma_if),
		.io_resp_1_bits_uop_bp_debug_if(io_resp_bits_uop_bp_debug_if),
		.io_resp_1_bits_uop_bp_xcpt_if(io_resp_bits_uop_bp_xcpt_if),
		.io_resp_1_bits_uop_debug_fsrc(io_resp_bits_uop_debug_fsrc),
		.io_resp_1_bits_uop_debug_tsrc(io_resp_bits_uop_debug_tsrc)
	);
	IntToFP ifpu(
		.clock(clock),
		.reset(reset),
		.io_in_valid(io_req_valid),
		.io_in_bits_typeTagIn(io_req_bits_uop_fp_ctrl_typeTagIn),
		.io_in_bits_wflags(io_req_bits_uop_fp_ctrl_wflags),
		.io_in_bits_rm((&io_req_bits_uop_fp_rm ? io_fcsr_rm : io_req_bits_uop_fp_rm)),
		.io_in_bits_typ(io_req_bits_uop_fp_typ),
		.io_in_bits_in1(io_req_bits_rs1_data[63:0]),
		.io_out_bits_data(_ifpu_io_out_bits_data),
		.io_out_bits_exc(io_resp_bits_fflags_bits)
	);
	assign io_resp_valid = _pipe_io_resp_1_valid;
	...
	assign io_resp_bits_fflags_valid = _pipe_io_resp_1_valid;
endmodule
