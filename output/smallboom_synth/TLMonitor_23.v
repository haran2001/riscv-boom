module TLMonitor_23 (
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		if (reset) begin
			...
			reg [19:0] _a_sizes_set_T_1;
			_a_opcodes_set_T_1 = {15'h0000, (_GEN_0 ? {io_in_a_bits_opcode, 1'h1} : 4'h0)} << {16'h0000, io_in_a_bits_source, 2'h0};
			_a_sizes_set_T_1 = {15'h0000, (_GEN_0 ? {io_in_a_bits_size, 1'h1} : 5'h00)} << {16'h0000, io_in_a_bits_source, 3'h0};
			d_clr = (_d_first_T_2 & d_first_1) & ~d_release_ack;
			d_clr_1 = (_d_first_T_2 & d_first_2) & d_release_ack;
			...
			inflight <= {1'h0, (inflight[0] | (_GEN_0 & ~io_in_a_bits_source)) & ~d_clr};
			inflight_opcodes <= (inflight_opcodes | (_GEN_0 ? _a_opcodes_set_T_1[3:0] : 4'h0)) & ~{4 {d_clr}};
			inflight_sizes <= (inflight_sizes | (_GEN_0 ? _a_sizes_set_T_1[7:0] : 8'h00)) & ~{8 {d_clr}};
