module AXI4UserYanker_1 (
	...
	wire _GEN = (auto_in_ar_bits_id ? _Queue4_BundleMap_1_io_enq_ready : _Queue4_BundleMap_io_enq_ready);
	wire _GEN_0 = auto_out_r_valid & auto_in_r_ready;
	wire _GEN_1 = auto_in_ar_valid & auto_out_ar_ready;
	wire _GEN_2 = (auto_in_aw_bits_id ? _Queue4_BundleMap_3_io_enq_ready : _Queue4_BundleMap_2_io_enq_ready);
	...
	assign auto_in_b_bits_echo_extra_id = (auto_out_b_bits_id ? _Queue4_BundleMap_3_io_deq_bits_extra_id : _Queue4_BundleMap_2_io_deq_bits_extra_id);
	assign auto_in_b_bits_echo_real_last = (auto_out_b_bits_id ? _Queue4_BundleMap_3_io_deq_bits_real_last : _Queue4_BundleMap_2_io_deq_bits_real_last);
	assign auto_in_ar_ready = auto_out_ar_ready & _GEN;
	assign auto_in_r_valid = auto_out_r_valid;
	assign auto_in_r_bits_id = auto_out_r_bits_id;
	assign auto_in_r_bits_data = auto_out_r_bits_data;
	assign auto_in_r_bits_resp = auto_out_r_bits_resp;
	assign auto_in_r_bits_echo_extra_id = (auto_out_r_bits_id ? _Queue4_BundleMap_1_io_deq_bits_extra_id : _Queue4_BundleMap_io_deq_bits_extra_id);
	assign auto_in_r_bits_echo_real_last = (auto_out_r_bits_id ? _Queue4_BundleMap_1_io_deq_bits_real_last : _Queue4_BundleMap_io_deq_bits_real_last);
