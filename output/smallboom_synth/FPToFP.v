module FPToFP (
	...
	wire [64:0] fsgnjMux_data = (_GEN ? (&in_pipe_b_in1[63:61] ? 65'h0e008000000000000 : in_pipe_b_in1) : (in_pipe_b_wflags ? (&in_pipe_b_in1[63:61] & (&in_pipe_b_in2[63:61]) ? 65'h0e008000000000000 : (&in_pipe_b_in2[63:61] | ((in_pipe_b_rm[0] != io_lt) & ~(&in_pipe_b_in1[63:61])) ? in_pipe_b_in1 : in_pipe_b_in2)) : {(in_pipe_b_rm[1] ? in_pipe_b_in1[64] ^ in_pipe_b_in2[64] : in_pipe_b_rm[0] ^ in_pipe_b_in2[64]), in_pipe_b_in1[63:0]}));
	reg io_out_pipe_v;
	...
	always @(posedge clock) begin
		...
		if (in_pipe_v) begin : sv2v_autoblock_1
			reg _GEN_0;
			reg [8:0] _mux_data_expOut_commonCase_T;
			_mux_data_expOut_commonCase_T = fsgnjMux_data[60:52] - 9'h100;
			_GEN_0 = in_pipe_b_typeTagOut == 2'h0;
			...
			io_out_pipe_b_exc <= (_GEN & _GEN_0 ? _narrower_io_exceptionFlags : (_GEN ? {&in_pipe_b_in1[63:61] & ~in_pipe_b_in1[51], 4'h0} : (in_pipe_b_wflags ? {(&in_pipe_b_in1[63:61] & ~in_pipe_b_in1[51]) | (&in_pipe_b_in2[63:61] & ~in_pipe_b_in2[51]), 4'h0} : 5'h00)));
		end
