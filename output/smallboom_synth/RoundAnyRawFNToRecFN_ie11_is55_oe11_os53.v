module RoundAnyRawFNToRecFN_ie11_is55_oe11_os53 (
	...
	wire [54:0] roundedSig = ((_overflow_roundMagUp_T & |_roundPosBit_T) | (roundMagUp & anyRound) ? ({1'h0, io_in_sig[55:2] | {_roundMask_T_128[53:1], _common_underflow_T_4}} + 55'h00000000000001) & ~((roundingMode_near_even & |_roundPosBit_T) & ~(|_anyRoundExtra_T) ? {_roundMask_T_128[53:1], _common_underflow_T_4, 1'h1} : 55'h00000000000000) : {1'h0, io_in_sig[55:2] & {~_roundMask_T_128[53:1], ~_common_underflow_T_4}} | (roundingMode_odd & anyRound ? _GEN_1 & _GEN_2 : 55'h00000000000000));
	wire [13:0] sRoundedExp = {io_in_sExp[12], io_in_sExp} + {12'h000, roundedSig[54:53]};
	wire common_totalUnderflow = $signed(sRoundedExp) < 14'sh03ce;
	...
	assign io_out = {~isNaNOut & io_in_sign, (((((((sRoundedExp[11:0] & ~(io_in_isZero | common_totalUnderflow ? 12'he00 : 12'h000)) & ~(pegMinNonzeroMagOut ? 12'hc31 : 12'h000)) & {1'h1, ~pegMaxFiniteMagOut, 10'h3ff}) & {2'h3, ~notNaN_isInfOut, 9'h1ff}) | (pegMinNonzeroMagOut ? 12'h3ce : 12'h000)) | (pegMaxFiniteMagOut ? 12'hbff : 12'h000)) | (notNaN_isInfOut ? 12'hc00 : 12'h000)) | (isNaNOut ? 12'he00 : 12'h000), ((isNaNOut | io_in_isZero) | common_totalUnderflow ? {isNaNOut, 51'h0000000000000} : (io_in_sig[55] ? roundedSig[52:1] : roundedSig[51:0])) | {52 {pegMaxFiniteMagOut}}};
