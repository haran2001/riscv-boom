module FPUFMAPipe_l4_f32 (
	...
	always @(posedge clock) begin
		...
		if (io_in_valid) begin
			...
			in_in2 <= (io_in_bits_swap23 ? 65'h00000000080000000 : io_in_bits_in2);
			in_in3 <= (io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : {32'h00000000, (io_in_bits_in1[32:0] ^ io_in_bits_in2[32:0]) & 33'h100000000});
		end
		if (_fma_io_validout) begin
			io_out_pipe_b_data <= {32'h00000000, _fma_io_out};
