module Arbiter2_BoomDCacheReqInternal (
	...
	output wire [39:0] io_out_bits_addr;
	output wire io_out_bits_is_hella;
	output wire [3:0] io_out_bits_way_en;
	output wire [4:0] io_out_bits_sdq_id;
	...
	assign io_out_bits_uop_iq_type_0 = (io_in_0_valid ? io_in_0_bits_uop_iq_type_0 : io_in_1_bits_uop_iq_type_0);
	assign io_out_bits_uop_iq_type_1 = (io_in_0_valid ? io_in_0_bits_uop_iq_type_1 : io_in_1_bits_uop_iq_type_1);
	assign io_out_bits_uop_iq_type_2 = (io_in_0_valid ? io_in_0_bits_uop_iq_type_2 : io_in_1_bits_uop_iq_type_2);
	assign io_out_bits_uop_iq_type_3 = (io_in_0_valid ? io_in_0_bits_uop_iq_type_3 : io_in_1_bits_uop_iq_type_3);
	assign io_out_bits_uop_fu_code_0 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_0 : io_in_1_bits_uop_fu_code_0);
	assign io_out_bits_uop_fu_code_1 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_1 : io_in_1_bits_uop_fu_code_1);
	assign io_out_bits_uop_fu_code_2 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_2 : io_in_1_bits_uop_fu_code_2);
	assign io_out_bits_uop_fu_code_3 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_3 : io_in_1_bits_uop_fu_code_3);
	assign io_out_bits_uop_fu_code_4 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_4 : io_in_1_bits_uop_fu_code_4);
	assign io_out_bits_uop_fu_code_5 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_5 : io_in_1_bits_uop_fu_code_5);
	assign io_out_bits_uop_fu_code_6 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_6 : io_in_1_bits_uop_fu_code_6);
	assign io_out_bits_uop_fu_code_7 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_7 : io_in_1_bits_uop_fu_code_7);
	assign io_out_bits_uop_fu_code_8 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_8 : io_in_1_bits_uop_fu_code_8);
	assign io_out_bits_uop_fu_code_9 = (io_in_0_valid ? io_in_0_bits_uop_fu_code_9 : io_in_1_bits_uop_fu_code_9);
	assign io_out_bits_uop_iw_issued = (io_in_0_valid ? io_in_0_bits_uop_iw_issued : io_in_1_bits_uop_iw_issued);
	assign io_out_bits_uop_iw_issued_partial_agen = (io_in_0_valid ? io_in_0_bits_uop_iw_issued_partial_agen : io_in_1_bits_uop_iw_issued_partial_agen);
	assign io_out_bits_uop_iw_issued_partial_dgen = (io_in_0_valid ? io_in_0_bits_uop_iw_issued_partial_dgen : io_in_1_bits_uop_iw_issued_partial_dgen);
	assign io_out_bits_uop_iw_p1_speculative_child = (io_in_0_valid ? io_in_0_bits_uop_iw_p1_speculative_child : io_in_1_bits_uop_iw_p1_speculative_child);
	assign io_out_bits_uop_iw_p2_speculative_child = (io_in_0_valid ? io_in_0_bits_uop_iw_p2_speculative_child : io_in_1_bits_uop_iw_p2_speculative_child);
	assign io_out_bits_uop_iw_p1_bypass_hint = (io_in_0_valid ? io_in_0_bits_uop_iw_p1_bypass_hint : io_in_1_bits_uop_iw_p1_bypass_hint);
	assign io_out_bits_uop_iw_p2_bypass_hint = (io_in_0_valid ? io_in_0_bits_uop_iw_p2_bypass_hint : io_in_1_bits_uop_iw_p2_bypass_hint);
	assign io_out_bits_uop_iw_p3_bypass_hint = (io_in_0_valid ? io_in_0_bits_uop_iw_p3_bypass_hint : io_in_1_bits_uop_iw_p3_bypass_hint);
	assign io_out_bits_uop_dis_col_sel = (io_in_0_valid ? io_in_0_bits_uop_dis_col_sel : io_in_1_bits_uop_dis_col_sel);
	...
	assign io_out_bits_uop_br_type = (io_in_0_valid ? io_in_0_bits_uop_br_type : io_in_1_bits_uop_br_type);
	...
	assign io_out_bits_uop_is_sfence = (io_in_0_valid ? io_in_0_bits_uop_is_sfence : io_in_1_bits_uop_is_sfence);
	assign io_out_bits_uop_is_amo = (io_in_0_valid ? io_in_0_bits_uop_is_amo : io_in_1_bits_uop_is_amo);
	assign io_out_bits_uop_is_eret = (io_in_0_valid ? io_in_0_bits_uop_is_eret : io_in_1_bits_uop_is_eret);
	assign io_out_bits_uop_is_sys_pc2epc = (io_in_0_valid ? io_in_0_bits_uop_is_sys_pc2epc : io_in_1_bits_uop_is_sys_pc2epc);
	assign io_out_bits_uop_is_rocc = (io_in_0_valid ? io_in_0_bits_uop_is_rocc : io_in_1_bits_uop_is_rocc);
	assign io_out_bits_uop_is_mov = (io_in_0_valid ? io_in_0_bits_uop_is_mov : io_in_1_bits_uop_is_mov);
	...
	assign io_out_bits_uop_imm_rename = (io_in_0_valid ? io_in_0_bits_uop_imm_rename : io_in_1_bits_uop_imm_rename);
	assign io_out_bits_uop_imm_sel = (io_in_0_valid ? io_in_0_bits_uop_imm_sel : io_in_1_bits_uop_imm_sel);
	assign io_out_bits_uop_pimm = (io_in_0_valid ? io_in_0_bits_uop_pimm : io_in_1_bits_uop_pimm);
	assign io_out_bits_uop_imm_packed = (io_in_0_valid ? io_in_0_bits_uop_imm_packed : io_in_1_bits_uop_imm_packed);
	assign io_out_bits_uop_op1_sel = (io_in_0_valid ? io_in_0_bits_uop_op1_sel : io_in_1_bits_uop_op1_sel);
	assign io_out_bits_uop_op2_sel = (io_in_0_valid ? io_in_0_bits_uop_op2_sel : io_in_1_bits_uop_op2_sel);
	assign io_out_bits_uop_fp_ctrl_ldst = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_ldst : io_in_1_bits_uop_fp_ctrl_ldst);
	assign io_out_bits_uop_fp_ctrl_wen = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_wen : io_in_1_bits_uop_fp_ctrl_wen);
	assign io_out_bits_uop_fp_ctrl_ren1 = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_ren1 : io_in_1_bits_uop_fp_ctrl_ren1);
	assign io_out_bits_uop_fp_ctrl_ren2 = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_ren2 : io_in_1_bits_uop_fp_ctrl_ren2);
	assign io_out_bits_uop_fp_ctrl_ren3 = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_ren3 : io_in_1_bits_uop_fp_ctrl_ren3);
	assign io_out_bits_uop_fp_ctrl_swap12 = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_swap12 : io_in_1_bits_uop_fp_ctrl_swap12);
	assign io_out_bits_uop_fp_ctrl_swap23 = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_swap23 : io_in_1_bits_uop_fp_ctrl_swap23);
	assign io_out_bits_uop_fp_ctrl_typeTagIn = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_typeTagIn : io_in_1_bits_uop_fp_ctrl_typeTagIn);
	assign io_out_bits_uop_fp_ctrl_typeTagOut = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_typeTagOut : io_in_1_bits_uop_fp_ctrl_typeTagOut);
	assign io_out_bits_uop_fp_ctrl_fromint = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_fromint : io_in_1_bits_uop_fp_ctrl_fromint);
	assign io_out_bits_uop_fp_ctrl_toint = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_toint : io_in_1_bits_uop_fp_ctrl_toint);
	assign io_out_bits_uop_fp_ctrl_fastpipe = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_fastpipe : io_in_1_bits_uop_fp_ctrl_fastpipe);
	assign io_out_bits_uop_fp_ctrl_fma = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_fma : io_in_1_bits_uop_fp_ctrl_fma);
	assign io_out_bits_uop_fp_ctrl_div = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_div : io_in_1_bits_uop_fp_ctrl_div);
	assign io_out_bits_uop_fp_ctrl_sqrt = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_sqrt : io_in_1_bits_uop_fp_ctrl_sqrt);
	assign io_out_bits_uop_fp_ctrl_wflags = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_wflags : io_in_1_bits_uop_fp_ctrl_wflags);
	assign io_out_bits_uop_fp_ctrl_vec = (io_in_0_valid ? io_in_0_bits_uop_fp_ctrl_vec : io_in_1_bits_uop_fp_ctrl_vec);
	...
	assign io_out_bits_uop_csr_cmd = (io_in_0_valid ? io_in_0_bits_uop_csr_cmd : io_in_1_bits_uop_csr_cmd);
	...
	assign io_out_bits_uop_fcn_dw = (io_in_0_valid ? io_in_0_bits_uop_fcn_dw : io_in_1_bits_uop_fcn_dw);
	assign io_out_bits_uop_fcn_op = (io_in_0_valid ? io_in_0_bits_uop_fcn_op : io_in_1_bits_uop_fcn_op);
	assign io_out_bits_uop_fp_val = (io_in_0_valid ? io_in_0_bits_uop_fp_val : io_in_1_bits_uop_fp_val);
	assign io_out_bits_uop_fp_rm = (io_in_0_valid ? io_in_0_bits_uop_fp_rm : io_in_1_bits_uop_fp_rm);
	assign io_out_bits_uop_fp_typ = (io_in_0_valid ? io_in_0_bits_uop_fp_typ : io_in_1_bits_uop_fp_typ);
