module BranchKillableQueue_4 (
	...
	wire [3:0] _GEN_1 = {uops_3_is_amo, uops_2_is_amo, uops_1_is_amo, uops_0_is_amo};
	wire [15:0] _GEN_2 = {uops_3_ldq_idx, uops_2_ldq_idx, uops_1_ldq_idx, uops_0_ldq_idx};
	wire [15:0] _GEN_3 = {uops_3_stq_idx, uops_2_stq_idx, uops_1_stq_idx, uops_0_stq_idx};
	wire [3:0] _GEN_4 = {uops_3_uses_ldq, uops_2_uses_ldq, uops_1_uses_ldq, uops_0_uses_ldq};
	wire [3:0] _GEN_5 = {uops_3_uses_stq, uops_2_uses_stq, uops_1_uses_stq, uops_0_uses_stq};
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		_GEN_6 = enq_ptr_value == 2'h0;
		_GEN_7 = do_enq & _GEN_6;
		_GEN_8 = enq_ptr_value == 2'h1;
		_GEN_9 = do_enq & _GEN_8;
		_GEN_10 = enq_ptr_value == 2'h2;
		_GEN_11 = do_enq & _GEN_10;
		_GEN_12 = do_enq & (&enq_ptr_value);
		...
		if (reset) begin
			...
			valids_0 <= ~(do_deq & (deq_ptr_value == 2'h0)) & (_GEN_7 | ((valids_0 & ((io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 8'h00)) & ~(io_flush & uops_0_uses_ldq)));
			valids_1 <= ~(do_deq & (deq_ptr_value == 2'h1)) & (_GEN_9 | ((valids_1 & ((io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 8'h00)) & ~(io_flush & uops_1_uses_ldq)));
			valids_2 <= ~(do_deq & (deq_ptr_value == 2'h2)) & (_GEN_11 | ((valids_2 & ((io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 8'h00)) & ~(io_flush & uops_2_uses_ldq)));
			valids_3 <= ~(do_deq & (&deq_ptr_value)) & (_GEN_12 | ((valids_3 & ((io_brupdate_b1_mispredict_mask & uops_3_br_mask) == 8'h00)) & ~(io_flush & uops_3_uses_ldq)));
			if (do_enq)
	...
	assign io_deq_bits_uop_is_amo = _GEN_1[deq_ptr_value];
	assign io_deq_bits_uop_ldq_idx = _GEN_2[deq_ptr_value * 4+:4];
	assign io_deq_bits_uop_stq_idx = _GEN_3[deq_ptr_value * 4+:4];
	assign io_deq_bits_uop_uses_ldq = _GEN_4[deq_ptr_value];
	assign io_deq_bits_uop_uses_stq = _GEN_5[deq_ptr_value];
