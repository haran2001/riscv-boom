module IssueSlot (
	...
	io_in_uop_bits_fp_rm,
	io_in_uop_bits_fp_typ,
	...
	output wire [2:0] io_iss_uop_fp_rm;
	output wire [1:0] io_iss_uop_fp_typ;
	...
	input [2:0] io_in_uop_bits_fp_rm;
	input [1:0] io_in_uop_bits_fp_typ;
	...
	output wire [2:0] io_out_uop_fp_rm;
	output wire [1:0] io_out_uop_fp_typ;
	...
	reg slot_uop_fp_val;
	reg [2:0] slot_uop_fp_rm;
	reg [1:0] slot_uop_fp_typ;
	...
	wire prs1_wakeups_0 = io_wakeup_ports_0_valid & (io_wakeup_ports_0_bits_uop_pdst == slot_uop_prs1);
	wire prs2_wakeups_0 = io_wakeup_ports_0_valid & (io_wakeup_ports_0_bits_uop_pdst == slot_uop_prs2);
	wire prs3_wakeups_0 = io_wakeup_ports_0_valid & (io_wakeup_ports_0_bits_uop_pdst == slot_uop_prs3);
	wire _GEN = prs1_wakeups_0 | (io_wakeup_ports_1_valid & (io_wakeup_ports_1_bits_uop_pdst == slot_uop_prs1));
	wire next_uop_prs1_busy = ~_GEN & slot_uop_prs1_busy;
	wire next_uop_iw_p1_bypass_hint = _GEN & prs1_wakeups_0;
	wire _GEN_0 = prs2_wakeups_0 | (io_wakeup_ports_1_valid & (io_wakeup_ports_1_bits_uop_pdst == slot_uop_prs2));
	wire next_uop_prs2_busy = ~_GEN_0 & slot_uop_prs2_busy;
	wire next_uop_iw_p2_bypass_hint = _GEN_0 & prs2_wakeups_0;
	wire _GEN_1 = prs3_wakeups_0 | (io_wakeup_ports_1_valid & (io_wakeup_ports_1_bits_uop_pdst == slot_uop_prs3));
	wire next_uop_prs3_busy = ~_GEN_1 & slot_uop_prs3_busy;
	wire next_uop_iw_p3_bypass_hint = _GEN_1 & prs3_wakeups_0;
	wire next_uop_iw_issued = io_grant & ~io_squash_grant;
	assign next_valid = ~(slot_valid & slot_uop_iw_issued) & slot_valid;
	always @(posedge clock) begin
		...
		if (io_in_uop_valid) begin
			...
			slot_uop_fp_rm <= io_in_uop_bits_fp_rm;
			slot_uop_fp_typ <= io_in_uop_bits_fp_typ;
		...
		slot_uop_iw_p1_speculative_child <= io_in_uop_valid & io_in_uop_bits_iw_p1_speculative_child;
		slot_uop_iw_p2_speculative_child <= io_in_uop_valid & io_in_uop_bits_iw_p2_speculative_child;
	...
	assign io_request = ((((slot_valid & ~slot_uop_iw_issued) & ~slot_uop_prs1_busy) & ~slot_uop_prs2_busy) & ~slot_uop_ppred_busy) & ~slot_uop_prs3_busy;
	...
	assign io_iss_uop_fp_rm = slot_uop_fp_rm;
	assign io_iss_uop_fp_typ = slot_uop_fp_typ;
	...
	assign io_out_uop_fp_rm = slot_uop_fp_rm;
	assign io_out_uop_fp_typ = slot_uop_fp_typ;
