module TageTable_4 (
	...
	wire [51:0] _tage_table_32_ext_R0_data;
	wire [7:0] _tage_u_32_ext_R0_data;
	reg doing_reset;
	reg [6:0] reset_idx;
	...
	assign s2_req_rtage_0_tag = _tage_table_32_ext_R0_data[11:3];
	assign s2_req_rtage_0_valid = _tage_table_32_ext_R0_data[12];
	assign s2_req_rtage_1_tag = _tage_table_32_ext_R0_data[24:16];
	assign s2_req_rtage_1_valid = _tage_table_32_ext_R0_data[25];
	assign s2_req_rtage_2_tag = _tage_table_32_ext_R0_data[37:29];
	assign s2_req_rtage_2_valid = _tage_table_32_ext_R0_data[38];
	assign s2_req_rtage_3_tag = _tage_table_32_ext_R0_data[50:42];
	assign s2_req_rtage_3_valid = _tage_table_32_ext_R0_data[51];
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		reg [8:0] _tag_history_T_1;
		reg _GEN_3;
		reg _GEN_4;
		reg _GEN_5;
		_tag_history_T_1 = (io_f1_req_ghist[8:0] ^ io_f1_req_ghist[17:9]) ^ io_f1_req_ghist[26:18];
	...
	tage_u_128x8 tage_u_32_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_u_32_ext_R0_data),
	...
	tage_table_128x52 tage_table_32_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_table_32_ext_R0_data),
	...
	assign io_f2_resp_0_bits_ctr = _tage_table_32_ext_R0_data[2:0];
	assign io_f2_resp_0_bits_u = _tage_u_32_ext_R0_data[1:0];
	assign io_f2_resp_1_valid = (s2_req_rtage_1_valid & (s2_req_rtage_1_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_1_bits_ctr = _tage_table_32_ext_R0_data[15:13];
	assign io_f2_resp_1_bits_u = _tage_u_32_ext_R0_data[3:2];
	assign io_f2_resp_2_valid = (s2_req_rtage_2_valid & (s2_req_rtage_2_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_2_bits_ctr = _tage_table_32_ext_R0_data[28:26];
	assign io_f2_resp_2_bits_u = _tage_u_32_ext_R0_data[5:4];
	assign io_f2_resp_3_valid = (s2_req_rtage_3_valid & (s2_req_rtage_3_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_3_bits_ctr = _tage_table_32_ext_R0_data[41:39];
	assign io_f2_resp_3_bits_u = _tage_u_32_ext_R0_data[7:6];
endmodule
