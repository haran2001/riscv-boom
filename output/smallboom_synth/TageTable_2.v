module TageTable_2 (
	...
	wire [47:0] _tage_table_8_ext_R0_data;
	wire [7:0] _tage_u_8_ext_R0_data;
	reg doing_reset;
	reg [7:0] reset_idx;
	...
	assign s2_req_rtage_0_tag = _tage_table_8_ext_R0_data[10:3];
	assign s2_req_rtage_0_valid = _tage_table_8_ext_R0_data[11];
	assign s2_req_rtage_1_tag = _tage_table_8_ext_R0_data[22:15];
	assign s2_req_rtage_1_valid = _tage_table_8_ext_R0_data[23];
	assign s2_req_rtage_2_tag = _tage_table_8_ext_R0_data[34:27];
	assign s2_req_rtage_2_valid = _tage_table_8_ext_R0_data[35];
	assign s2_req_rtage_3_tag = _tage_table_8_ext_R0_data[46:39];
	assign s2_req_rtage_3_valid = _tage_table_8_ext_R0_data[47];
	...
	tage_u_256x8 tage_u_8_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_u_8_ext_R0_data),
	...
	tage_table_256x48 tage_table_8_ext(
		.R0_addr(s1_hashed_idx),
		.R0_en(io_f1_req_valid),
		.R0_clk(clock),
		.R0_data(_tage_table_8_ext_R0_data),
	...
	assign io_f2_resp_0_bits_ctr = _tage_table_8_ext_R0_data[2:0];
	assign io_f2_resp_0_bits_u = _tage_u_8_ext_R0_data[1:0];
	assign io_f2_resp_1_valid = (s2_req_rtage_1_valid & (s2_req_rtage_1_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_1_bits_ctr = _tage_table_8_ext_R0_data[14:12];
	assign io_f2_resp_1_bits_u = _tage_u_8_ext_R0_data[3:2];
	assign io_f2_resp_2_valid = (s2_req_rtage_2_valid & (s2_req_rtage_2_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_2_bits_ctr = _tage_table_8_ext_R0_data[26:24];
	assign io_f2_resp_2_bits_u = _tage_u_8_ext_R0_data[5:4];
	assign io_f2_resp_3_valid = (s2_req_rtage_3_valid & (s2_req_rtage_3_tag == s2_tag)) & ~doing_reset;
	assign io_f2_resp_3_bits_ctr = _tage_table_8_ext_R0_data[38:36];
	assign io_f2_resp_3_bits_u = _tage_u_8_ext_R0_data[7:6];
endmodule
