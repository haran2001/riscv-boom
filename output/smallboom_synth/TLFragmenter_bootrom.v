module TLFragmenter_bootrom (
	...
	output wire [16:0] auto_anon_out_a_bits_address;
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		reg _GEN_0;
		reg _GEN_1;
		_GEN_0 = auto_anon_in_d_ready & auto_anon_out_d_valid;
	...
	assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[16:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};
