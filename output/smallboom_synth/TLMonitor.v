module TLMonitor (
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		if (reset) begin
			...
			_GEN_51 = {136'h0000000000000000000000000000000000, io_in_d_bits_source, 3'h0};
			...
			_d_sizes_clr_T_5 = 143'h0000000000000000000000000000000000ff << _GEN_51;
			...
			_d_sizes_clr_T_11 = 143'h0000000000000000000000000000000000ff << _GEN_51;
			_GEN_50 = (_d_first_T_2 & d_first_1) & ~d_release_ack;
			_GEN_52 = (_d_first_T_2 & d_first_2) & d_release_ack;
			...
			inflight <= (inflight | (_GEN_1 ? 16'h0001 << _GEN_0 : 16'h0000)) & ~(_GEN_50 ? 16'h0001 << _GEN_2 : 16'h0000);
			inflight_opcodes <= (inflight_opcodes | (_GEN_1 ? _a_opcodes_set_T_1[63:0] : 64'h0000000000000000)) & ~(_GEN_50 ? _d_opcodes_clr_T_5[63:0] : 64'h0000000000000000);
			inflight_sizes <= (inflight_sizes | (_GEN_1 ? _a_sizes_set_T_1[127:0] : 128'h00000000000000000000000000000000)) & ~(_GEN_50 ? _d_sizes_clr_T_5[127:0] : 128'h00000000000000000000000000000000);
			if (_a_first_T_1 | _d_first_T_2)
				watchdog <= 32'h00000000;
			else
				watchdog <= watchdog + 32'h00000001;
			inflight_1 <= inflight_1 & ~(_GEN_52 ? 16'h0001 << _GEN_2 : 16'h0000);
			inflight_sizes_1 <= inflight_sizes_1 & ~(_GEN_52 ? _d_sizes_clr_T_11[127:0] : 128'h00000000000000000000000000000000);
		end
