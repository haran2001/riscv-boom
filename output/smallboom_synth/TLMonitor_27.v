module TLMonitor_27 (
	...
	always @(posedge clock) begin : sv2v_autoblock_1
		...
		if (reset) begin
			...
			_GEN_104 = (_d_first_T_3 & d_first_1) & ~d_release_ack;
			_GEN_105 = {73'h0000000000000000000, io_in_d_bits_source, 3'h0};
			_GEN_106 = (_d_first_T_3 & d_first_2) & d_release_ack;
			...
			_d_sizes_clr_T_5 = 79'h000000000000000000ff << _GEN_105;
			...
			_d_sizes_clr_T_11 = 79'h000000000000000000ff << _GEN_105;
			...
			inflight <= (inflight | (_GEN_2 ? _a_set_T[4:0] : 5'h00)) & ~(_GEN_104 ? _d_clr_T[4:0] : 5'h00);
			inflight_opcodes <= (inflight_opcodes | (_GEN_2 ? _a_opcodes_set_T_1[19:0] : 20'h00000)) & ~(_GEN_104 ? _d_opcodes_clr_T_5[19:0] : 20'h00000);
			inflight_sizes <= (inflight_sizes | (_GEN_2 ? _a_sizes_set_T_1[39:0] : 40'h0000000000)) & ~(_GEN_104 ? _d_sizes_clr_T_5[39:0] : 40'h0000000000);
			if (_a_first_T_1 | _d_first_T_3)
				watchdog <= 32'h00000000;
			else
				watchdog <= watchdog + 32'h00000001;
			inflight_1 <= (inflight_1 | (_GEN_6 ? _c_set_T[4:0] : 5'h00)) & ~(_GEN_106 ? _d_clr_T_1[4:0] : 5'h00);
			inflight_sizes_1 <= (inflight_sizes_1 | (_GEN_6 ? _c_sizes_set_T_1[39:0] : 40'h0000000000)) & ~(_GEN_106 ? _d_sizes_clr_T_11[39:0] : 40'h0000000000);
