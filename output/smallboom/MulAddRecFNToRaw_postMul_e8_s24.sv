...
module MulAddRecFNToRaw_postMul_e8_s24(	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7
  ...
  wire [49:0]  CDom_absSigSum =
    io_fromPreMul_doSubMags
      ...
      : {1'h0,
         ...
         _sigSum_T_3[23:0],
         io_mulAddResult[47:25]};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:16, :205:12, :206:{13,20}, :207:22, :209:{46,71}, :210:23
  ...
  wire [8:0]   CDom_reduced4SigExtra_shift =
    $signed(9'sh100 >>> ~(io_fromPreMul_CDom_CAlignDist[4:2]));	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:223:51, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :76:56
  wire [50:0]  notCDom_absSigSum =
    _sigSum_T_3[2]
      ? ~{_sigSum_T_3[1:0], io_mulAddResult[47:0], io_fromPreMul_bit0AlignedSigC}
      : {_sigSum_T_3[1:0], io_mulAddResult[47:0], io_fromPreMul_bit0AlignedSigC}
        + {50'h0, io_fromPreMul_doSubMags};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:16, :196:28, :232:36, :234:12, :235:{13,20}, :236:41
                                                                                      ...
                                                                                      : (|(notCDom_absSigSum[9:8]))
                                                                                          ...
                                                                                          : (|(notCDom_absSigSum[7:6]))
                                                                                              ...
                                                                                              : (|(notCDom_absSigSum[5:4]))
                                                                                                  ? 5'h17
                                                                                                  : {4'hC,
                                                                                                     ~(|(notCDom_absSigSum[3:2]))};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:234:12, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:103:{33,54}, :106:15, src/main/scala/chisel3/util/Mux.scala:50:70
  wire [113:0] _notCDom_mainSig_T =
    {63'h0, notCDom_absSigSum} << {108'h0, notCDom_normDistReduced2, 1'h0};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:207:22, :234:12, :243:27, src/main/scala/chisel3/util/Mux.scala:50:70
  wire [16:0]  notCDom_reduced4SigExtra_shift =
    $signed(17'sh10000 >>> ~(notCDom_normDistReduced2[4:1]));	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:248:46, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :76:56, src/main/scala/chisel3/util/Mux.scala:50:70
  ...
  assign io_rawOut_sExp =
    io_fromPreMul_CIsDominant
      ...
      : io_fromPreMul_sExpSum - {4'h0, notCDom_normDistReduced2, 1'h0};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :203:43, :207:22, :241:46, :293:26, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:120:54, src/main/scala/chisel3/util/Mux.scala:50:70
         ...
         (|(_notCDom_mainSig_T[25:23]))
           | (|({|{|(notCDom_absSigSum[23:22]), |(notCDom_absSigSum[21:20])},
                ...
                & {notCDom_reduced4SigExtra_shift[1],
                   ...
                   notCDom_reduced4SigExtra_shift[6]}))};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :205:12, :214:12, :215:{14,21,36}, :216:{19,37}, :219:{24,56}, :222:72, :223:73, :225:{12,25}, :226:{25,32,61}, :234:12, :243:{27,50}, :247:{39,78}, :249:11, :251:{12,28}, :252:{28,35,39}, :294:25, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22, :103:{33,54}, :120:{33,54}
endmodule
