...
module IntToFP(	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
  input         clock,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
                reset,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
                io_in_valid,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:529:14
  ...
  wire [63:0] intValue_res =
    in_pipe_b_typ[1]
      ? in_pipe_b_in1
      : {{32{~(in_pipe_b_typ[0]) & in_pipe_b_in1[31]}}, in_pipe_b_in1[31:0]};	// generators/rocket-chip/src/main/scala/tile/FPU.scala:542:26, :544:33, :545:66, :546:{13,19,31}, generators/rocket-chip/src/main/scala/util/package.scala:163:13, src/main/scala/chisel3/util/Valid.scala:142:26
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
    ...
    if (in_pipe_v) begin	// src/main/scala/chisel3/util/Valid.scala:141:24
      automatic logic [63:0]  _mux_data_T_2;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23
      automatic logic         mux_data_rawIn_isZeroExpIn;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:48:30
      automatic logic [5:0]   mux_data_rawIn_normDist;	// src/main/scala/chisel3/util/Mux.scala:50:70
      automatic logic [11:0]  _mux_data_rawIn_adjustedExp_T_4;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:57:9
      automatic logic [114:0] _mux_data_rawIn_subnormFract_T;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:52:33
      automatic logic [51:0]  _mux_data_rawIn_out_sig_T_2;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:70:33
      automatic logic [2:0]   _mux_data_T_4;	// generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:15
      automatic logic         _GEN;	// generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:76
      automatic logic         mux_data_rawIn_isZeroExpIn_1;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:48:30
      automatic logic [4:0]   mux_data_rawIn_normDist_1;	// src/main/scala/chisel3/util/Mux.scala:50:70
      automatic logic [8:0]   _mux_data_rawIn_adjustedExp_T_9;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:57:9
      automatic logic [2:0]   _mux_data_T_13;	// generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:15
      automatic logic [64:0]  i2fResults_1_1 =
        ({65{_i2fResults_i2f_1_io_out[63:61] != 3'h7}} | 65'h1EFEFFFFFFFFFFFFF)
        & _i2fResults_i2f_1_io_out;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :413:27, :414:10, :556:23
      automatic logic [53:0]  _mux_data_rawIn_subnormFract_T_2;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:52:33
      _mux_data_T_2 =
        (in_pipe_b_typeTagIn[0] ? 64'h0 : 64'hFFFFFFFF00000000) | in_pipe_b_in1;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, generators/rocket-chip/src/main/scala/util/package.scala:38:47, :39:76, src/main/scala/chisel3/util/Valid.scala:142:26
      mux_data_rawIn_isZeroExpIn = _mux_data_T_2[62:52] == 11'h0;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:45:19, :48:30, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  : _mux_data_T_2[4]
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      : _mux_data_T_2[3]
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          : _mux_data_T_2[2]
                                                                                                                                                                                                              ? 6'h31
                                                                                                                                                                                                              : {5'h19,
                                                                                                                                                                                                                 ~(_mux_data_T_2[1])};	// generators/hardfloat/hardfloat/src/main/scala/primitives.scala:91:52, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Mux.scala:50:70
      _mux_data_rawIn_adjustedExp_T_4 =
        (mux_data_rawIn_isZeroExpIn
           ? {6'h3F, ~mux_data_rawIn_normDist}
           : {1'h0, _mux_data_T_2[62:52]})
        + {10'h100, mux_data_rawIn_isZeroExpIn ? 2'h2 : 2'h1};	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:45:19, :48:30, :54:10, :55:18, :57:9, :58:14, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Mux.scala:50:70, src/main/scala/chisel3/util/Valid.scala:141:24
      _mux_data_rawIn_subnormFract_T =
        {63'h0, _mux_data_T_2[51:0]} << mux_data_rawIn_normDist;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :52:33, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Mux.scala:50:70
      _mux_data_rawIn_out_sig_T_2 =
        mux_data_rawIn_isZeroExpIn
          ? {_mux_data_rawIn_subnormFract_T[50:0], 1'h0}
          : _mux_data_T_2[51:0];	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :48:30, :52:{33,46,64}, :70:33, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Valid.scala:141:24
      _mux_data_T_4 =
        mux_data_rawIn_isZeroExpIn & ~(|(_mux_data_T_2[51:0]))
          ? 3'h0
          : _mux_data_rawIn_adjustedExp_T_4[11:9];	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :48:30, :49:34, :57:9, :60:30, generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:{15,50}, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, :528:7
      _GEN =
        _mux_data_T_4[0] | (&(_mux_data_rawIn_adjustedExp_T_4[11:10]))
        & (|(_mux_data_T_2[51:0]));	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :49:34, :57:9, :61:{32,57}, :64:28, generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:{15,76}, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23
      mux_data_rawIn_isZeroExpIn_1 = _mux_data_T_2[30:23] == 8'h0;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:45:19, :48:30, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23
                                                                              ...
                                                                              : _mux_data_T_2[4]
                                                                                  ...
                                                                                  : _mux_data_T_2[3]
                                                                                      ...
                                                                                      : _mux_data_T_2[2]
                                                                                          ...
                                                                                          : _mux_data_T_2[1]
                                                                                              ? 5'h15
                                                                                              : 5'h16;	// generators/hardfloat/hardfloat/src/main/scala/primitives.scala:91:52, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, :538:11, src/main/scala/chisel3/util/Mux.scala:50:70
      _mux_data_rawIn_adjustedExp_T_9 =
        (mux_data_rawIn_isZeroExpIn_1
           ? {4'hF, ~mux_data_rawIn_normDist_1}
           : {1'h0, _mux_data_T_2[30:23]})
        + {7'h20, mux_data_rawIn_isZeroExpIn_1 ? 2'h2 : 2'h1};	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:45:19, :48:30, :54:10, :55:18, :57:9, :58:14, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Mux.scala:50:70, src/main/scala/chisel3/util/Valid.scala:141:24
      _mux_data_T_13 =
        mux_data_rawIn_isZeroExpIn_1 & ~(|(_mux_data_T_2[22:0]))
          ? 3'h0
          : _mux_data_rawIn_adjustedExp_T_9[8:6];	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :48:30, :49:34, :57:9, :60:30, generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:{15,50}, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, :528:7
      _mux_data_rawIn_subnormFract_T_2 =
        {31'h0, _mux_data_T_2[22:0]} << mux_data_rawIn_normDist_1;	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:46:21, :52:33, generators/rocket-chip/src/main/scala/tile/FPU.scala:431:23, src/main/scala/chisel3/util/Mux.scala:50:70
      io_out_pipe_b_data <=
        in_pipe_b_wflags
          ? (in_pipe_b_typeTagIn[0]
               ? i2fResults_1_1
               : {i2fResults_1_1[64:33], _i2fResults_i2f_io_out})
          : {_mux_data_T_2[63],
             _mux_data_T_4[2:1],
             _GEN,
             (&{_mux_data_T_4[2:1], _GEN})
               ? {&(_mux_data_rawIn_out_sig_T_2[51:32]),
                  _mux_data_rawIn_adjustedExp_T_4[7:1],
                  _mux_data_T_13[2],
                  _mux_data_rawIn_out_sig_T_2[51:32],
                  _mux_data_T_2[31],
                  _mux_data_T_13[1],
                  _mux_data_T_13[0] | (&(_mux_data_rawIn_adjustedExp_T_9[8:7]))
                    & (|(_mux_data_T_2[22:0])),
                  _mux_data_rawIn_adjustedExp_T_9[5:0],
                  mux_data_rawIn_isZeroExpIn_1
                    ? {_mux_data_rawIn_subnormFract_T_2[21:0], 1'h0}
                    : _mux_data_T_2[22:0]}
               : {_mux_data_rawIn_adjustedExp_T_4[8:0], _mux_data_rawIn_out_sig_T_2}};	// generators/hardfloat/hardfloat/src/main/scala/rawFloatFromFN.scala:44:18, :46:21, :48:30, :49:34, :52:{33,46,64}, :57:9, :61:{32,57}, :64:28, :70:33, generators/hardfloat/hardfloat/src/main/scala/recFNFromFN.scala:48:{15,76}, :50:{23,41}, generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :336:26, :338:{8,42}, :339:8, :340:8, :343:8, :344:8, :414:10, :431:23, :539:12, :552:25, :556:23, :565:{44,55}, :566:14, generators/rocket-chip/src/main/scala/util/package.scala:38:47, :39:76, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26
      io_out_pipe_b_exc <=
        in_pipe_b_wflags
          ? (in_pipe_b_typeTagIn[0]
               ? _i2fResults_i2f_1_io_exceptionFlags
               : _i2fResults_i2f_io_exceptionFlags)
          : 5'h0;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:538:11, :552:25, :556:23, :567:13, generators/rocket-chip/src/main/scala/util/package.scala:38:47, :39:76, src/main/scala/chisel3/util/Valid.scala:142:26
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
      automatic logic [31:0] _RANDOM[0:4];	// generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7
