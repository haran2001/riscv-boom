...
module MulDiv(	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
  input         clock,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
                reset,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
  ...
  wire         io_resp_valid_0 = state == 3'h6 | (&state);	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :125:13, :182:{27,42,51}
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
    automatic logic [2:0] decoded_invInputs = ~(io_req_bits_fn[2:0]);	// src/main/scala/chisel3/util/experimental/decode/decoder.scala:35:16, src/main/scala/chisel3/util/pla.scala:78:21
    ...
    automatic logic       lhs_sign;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:81:23
    automatic logic       rhs_sign;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:81:23
    automatic logic       _GEN;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:92:39
    automatic logic       _GEN_0;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:101:39
    automatic logic       _GEN_1;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:106:39
    automatic logic       _GEN_2;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:101:57, :106:50, :124:55, :125:13
    automatic logic       _GEN_3;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:129:39
    automatic logic       _GEN_4;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:138:17
    automatic logic       _GEN_5;	// src/main/scala/chisel3/util/Decoupled.scala:51:35
    lhs_sign =
      (|{decoded_invInputs[0], &_decoded_andMatrixOutputs_T})
      & (io_req_bits_dw ? io_req_bits_in1[63] : io_req_bits_in1[31]);	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:81:{23,29,38,48}, src/main/scala/chisel3/util/pla.scala:78:21, :91:29, :98:{53,70}, :114:{19,36}
    rhs_sign =
      (|{&_decoded_andMatrixOutputs_T, &{decoded_invInputs[0], io_req_bits_fn[2]}})
      & (io_req_bits_dw ? io_req_bits_in2[63] : io_req_bits_in2[31]);	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:81:{23,29,38,48}, src/main/scala/chisel3/util/pla.scala:78:21, :90:45, :91:29, :98:{53,70}, :114:{19,36}
    _GEN = state == 3'h1;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :92:39
    _GEN_0 = state == 3'h5;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :101:39
    _GEN_1 = state == 3'h2;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :106:39
    _GEN_2 = _GEN_1 & count == 7'h3F;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :101:57, :106:{39,50}, :124:{25,55}, :125:13
    _GEN_3 = state == 3'h3;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :99:11, :129:39
    _GEN_4 = count == 7'h40;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :119:38, :138:17
    _GEN_5 = io_req_ready_0 & io_req_valid;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:183:25, src/main/scala/chisel3/util/Decoupled.scala:51:35
    if (reset)	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
      ...
      state <= decoded_invInputs[2] ? 3'h2 : {1'h0, ~(lhs_sign | rhs_sign), 1'h1};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22, :78:{50,60}, :81:23, :106:39, :165:{17,36,46}, src/main/scala/chisel3/util/pla.scala:78:21, :91:29
    ...
    if (_GEN_5) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      ...
      count <= {1'h0, decoded_invInputs[2] & ~io_req_bits_dw, 5'h0};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :78:60, :168:{11,38,46}, src/main/scala/chisel3/util/pla.scala:78:21, :91:29
      ...
      divisor <=
        {rhs_sign,
         ...
         io_req_bits_in2[31:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:60:20, :81:23, :82:{17,29,43}, :83:15, :170:19
      remainder <=
        {66'h0,
         io_req_bits_dw ? io_req_bits_in1[63:32] : {32{lhs_sign}},
         io_req_bits_in1[31:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:61:22, :81:23, :82:{17,29,43}, :83:15, :94:17, :171:15
    end
    else begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      automatic logic [64:0] _subtractor_T_1;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:88:37
      automatic logic        _eOut_T_9;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:146:24
      automatic logic        divby0;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:146:32
      _subtractor_T_1 = remainder[128:64] - divisor;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:60:20, :61:22, :88:{29,37}
      _eOut_T_9 = count == 7'h0;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :123:20, :146:24
      divby0 = _eOut_T_9 & ~(_subtractor_T_1[64]);	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:88:37, :133:28, :146:{24,32,35}
      if (_GEN_3) begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:129:39
        automatic logic [5:0] _eOutPos_T;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:152:35
        _eOutPos_T =
          {|(remainder[63:32]),
           (|(remainder[63:32]))
             ? {|(remainder[63:48]),
                       ...
                       (|(divisor[15:8]))
                         ...
                         : {|(divisor[7:4]),
                            (|(divisor[7:4]))
                              ...
                              : divisor[3]
                                  ? 2'h3
                                  : divisor[2] ? 2'h2 : {1'h0, divisor[1]}}}}};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:60:20, :61:22, :78:60, :89:57, :150:36, :152:35, src/main/scala/chisel3/util/CircuitMath.scala:28:8, :30:{10,12}, :33:17, :34:17, :35:22, :36:{10,21}
        if (_eOut_T_9 & ~divby0 & _eOutPos_T != 6'h3F) begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:117:45, :146:{24,32}, :152:35, :153:{35,43,54}
          count <= {1'h0, ~_eOutPos_T};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :78:60, :152:{21,35}, :156:15
          ...
          remainder <=
            {1'h0,
             ...
             remainder[63:0],
             ~(_subtractor_T_1[64])};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:61:22, :78:60, :88:37, :89:57, :133:28, :134:{14,24,45,67}, :137:15
        end
      end
      else if (_GEN_1) begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:106:39
        automatic logic [65:0] _prod_T_4;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:112:76
        _prod_T_4 =
          {{65{remainder[64]}}, remainder[0]} * {divisor[64], divisor}
          + {remainder[129], remainder[129:65]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:60:20, :61:22, :107:31, :108:31, :109:24, :112:{38,67,76}
        count <= count + 7'h1;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :123:20
        remainder <=
          {_prod_T_4[65:1], count == 7'h3E & neg_out, _prod_T_4[0], remainder[63:1]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :57:20, :61:22, :109:24, :112:76, :113:38, :114:{32,61}, :120:26, :121:{21,34,67}
      end
        ...
        remainder <= {66'h0, 64'h0 - result};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:61:22, :78:60, :89:19, :90:27, :94:17
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
      automatic logic [31:0] _RANDOM[0:10];	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7
        ...
        remainder =
          {_RANDOM[4'h6][31:25],
           ...
           _RANDOM[4'h8],
           _RANDOM[4'h9],
           _RANDOM[4'hA][26:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7, :60:20, :61:22
      `endif // RANDOMIZE_REG_INIT
    end // initial
