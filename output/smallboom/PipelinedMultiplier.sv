...
module PipelinedMultiplier(	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
  input         clock,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
                reset,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
                io_req_valid,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:187:14
  ...
  input  [63:0] io_req_bits_in1,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:187:14
                io_req_bits_in2,	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:187:14
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
    ...
    if (in_pipe_v) begin	// src/main/scala/chisel3/util/Valid.scala:141:24
      automatic logic [1:0]   decoded_invInputs;	// src/main/scala/chisel3/util/pla.scala:78:21
      automatic logic [127:0] prod;	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:205:18
      decoded_invInputs = ~(in_pipe_b_fn[1:0]);	// src/main/scala/chisel3/util/Valid.scala:142:26, src/main/scala/chisel3/util/experimental/decode/decoder.scala:35:16, src/main/scala/chisel3/util/pla.scala:78:21
      prod =
        {{64{(|{decoded_invInputs[1], &{decoded_invInputs[0], in_pipe_b_fn[1]}})
               & in_pipe_b_in1[63]}},
         in_pipe_b_in1} * {{64{decoded_invInputs[1] & in_pipe_b_in2[63]}}, in_pipe_b_in2};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:203:{27,41}, :204:{27,41}, :205:18, src/main/scala/chisel3/util/Valid.scala:142:26, src/main/scala/chisel3/util/pla.scala:78:21, :90:45, :91:29, :98:{53,70}, :114:{19,36}
      io_resp_bits_data_pipe_b <=
        (|{in_pipe_b_fn[0], in_pipe_b_fn[1]})
          ? prod[127:64]
          : in_pipe_b_dw ? prod[63:0] : {{32{prod[31]}}, prod[31:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:205:18, :206:{18,30,53,67,101}, generators/rocket-chip/src/main/scala/util/package.scala:132:{15,20,38}, src/main/scala/chisel3/util/Valid.scala:142:26, src/main/scala/chisel3/util/pla.scala:90:45, :114:{19,36}
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
      automatic logic [31:0] _RANDOM[0:17];	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7
        ...
        io_resp_bits_data_pipe_b =
          {_RANDOM[5'hD][31:5], _RANDOM[5'hE], _RANDOM[5'hF][4:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26
        io_resp_bits_data_pipe_pipe_b =
          {_RANDOM[5'hF][31:6], _RANDOM[5'h10], _RANDOM[5'h11][5:0]};	// generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:186:7, src/main/scala/chisel3/util/Valid.scala:142:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
