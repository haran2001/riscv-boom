...
module CompareRecFN(	// generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7
  ...
  wire        common_ltMags =
    $signed({1'h0, io_a[63:52]}) < $signed({1'h0, io_b[63:52]}) | eqExps & _GEN < _GEN_0;	// generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:60:29, :62:{20,33,44,57}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:51:21, :52:53, :60:27, :61:44
  ...
  assign io_lt =
    ...
    & (io_a[64] & ~(io_b[64]) | ~bothInfs
       & (io_a[64] & ~common_ltMags & ~common_eqMags | ~(io_b[64]) & common_ltMags));	// generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7, :57:32, :58:33, :59:33, :62:33, :63:32, :66:9, :67:{25,28,41}, :68:{19,30}, :69:{38,54,57,74}, :70:41, :78:22, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25
  assign io_eq =
    ordered & (bothZeros | io_a[64] == io_b[64] & (bothInfs | common_eqMags));	// generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7, :57:32, :58:33, :59:33, :63:32, :72:{19,34,49,62}, :79:22, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25
  assign io_exceptionFlags =
    {rawA_isNaN & ~(io_a[51]) | rawB_isNaN & ~(io_b[51]) | io_signaling & ~ordered, 4'h0};	// generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7, :57:32, :75:58, :76:{27,30}, :81:34, generators/hardfloat/hardfloat/src/main/scala/common.scala:82:{46,49,56}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:56:33
endmodule
