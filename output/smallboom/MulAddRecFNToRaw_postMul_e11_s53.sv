...
module MulAddRecFNToRaw_postMul_e11_s53(	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7
  input          io_fromPreMul_isSigNaNAny,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isNaNAOrB,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isInfA,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isZeroA,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isInfB,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isZeroB,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_signProd,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isNaNC,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isInfC,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_isZeroC,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
  ...
  input          io_fromPreMul_doSubMags,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_fromPreMul_CIsDominant,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
  ...
  output         io_invalidExc,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_rawOut_isNaN,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_rawOut_isInf,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_rawOut_isZero,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
                 io_rawOut_sign,	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16
  ...
  wire [54:0]  _sigSum_T_3 =
    io_mulAddResult[106]
      ? io_fromPreMul_highAlignedSigC + 55'h1
      : io_fromPreMul_highAlignedSigC;	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:{16,32}, :193:47
  wire [107:0] CDom_absSigSum =
    io_fromPreMul_doSubMags
      ? ~{_sigSum_T_3, io_mulAddResult[105:53]}
      : {1'h0,
         io_fromPreMul_highAlignedSigC[54:53],
         _sigSum_T_3[52:0],
         io_mulAddResult[105:54]};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:16, :205:12, :206:{13,20}, :207:22, :209:{46,71}, :210:23
  ...
  wire [16:0]  CDom_reduced4SigExtra_shift =
    $signed(17'sh10000 >>> ~(io_fromPreMul_CDom_CAlignDist[5:2]));	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:223:51, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :76:56
  wire [108:0] notCDom_absSigSum =
    _sigSum_T_3[2]
      ? ~{_sigSum_T_3[1:0], io_mulAddResult[105:0], io_fromPreMul_bit0AlignedSigC}
      : {_sigSum_T_3[1:0], io_mulAddResult[105:0], io_fromPreMul_bit0AlignedSigC}
        + {108'h0, io_fromPreMul_doSubMags};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:16, :196:28, :232:36, :234:12, :235:{13,20}, :236:41
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              : (|(notCDom_absSigSum[7:6]))
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  : (|(notCDom_absSigSum[5:4]))
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      : (|(notCDom_absSigSum[3:2]))
                                                                                                                                                                                                                          ? 6'h35
                                                                                                                                                                                                                          : 6'h36;	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:234:12, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:103:{33,54}, :106:15, src/main/scala/chisel3/util/Mux.scala:50:70
  wire [235:0] _notCDom_mainSig_T =
    {127'h0, notCDom_absSigSum} << {229'h0, notCDom_normDistReduced2, 1'h0};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:207:22, :234:12, :243:27, src/main/scala/chisel3/util/Mux.scala:50:70
  wire [32:0]  notCDom_reduced4SigExtra_shift =
    $signed(33'sh100000000 >>> ~(notCDom_normDistReduced2[5:1]));	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:248:46, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :76:56, src/main/scala/chisel3/util/Mux.scala:50:70
  ...
  wire         notNaN_addZeros =
    (io_fromPreMul_isZeroA | io_fromPreMul_isZeroB) & io_fromPreMul_isZeroC;	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:267:{32,58}
  assign io_invalidExc =
    ...
    & notNaN_isInfProd & io_fromPreMul_isInfC & io_fromPreMul_doSubMags;	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :264:49, :272:31, :273:{32,57}, :274:10, :276:35
  ...
  assign io_rawOut_isZero =
    notNaN_addZeros | ~io_fromPreMul_CIsDominant & notCDom_completeCancellation;	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :255:50, :267:58, :282:25, :283:{14,42}
  assign io_rawOut_sign =
    ...
    & (io_fromPreMul_CIsDominant
         ...
         : notCDom_completeCancellation
             ? roundingMode_min
             : io_fromPreMul_signProd ^ _sigSum_T_3[2]);	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :186:45, :190:42, :192:16, :232:36, :255:50, :257:12, :259:36, :264:49, :265:44, :267:58, :285:27, :286:31, :287:29, :288:36, :289:46, :290:{37,50}, :291:{10,31,49}, :292:17
  assign io_rawOut_sExp =
    io_fromPreMul_CIsDominant
      ? io_fromPreMul_sExpSum - {12'h0, io_fromPreMul_doSubMags}
      : io_fromPreMul_sExpSum - {6'h0, notCDom_normDistReduced2, 1'h0};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :203:43, :207:22, :241:46, :293:26, src/main/scala/chisel3/util/Mux.scala:50:70
         ...
         (|(_notCDom_mainSig_T[54:52]))
           | (|({|{|(notCDom_absSigSum[51:50]), |(notCDom_absSigSum[49:48])},
                ...
                & {notCDom_reduced4SigExtra_shift[1],
                   ...
                   notCDom_reduced4SigExtra_shift[13]}))};	// generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :205:12, :214:12, :215:{14,21,36}, :216:{19,37}, :219:{24,56}, :222:72, :223:73, :225:{12,25}, :226:{25,32,61}, :234:12, :243:{27,50}, :247:{39,78}, :249:11, :251:{12,28}, :252:{28,35,39}, :294:25, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22, :103:{33,54}, :120:{33,54}
endmodule
