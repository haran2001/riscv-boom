...
module TLFragmenter_PLIC(	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
  input         clock,	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
                reset,	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
  ...
  input  [2:0]  auto_anon_in_a_bits_opcode,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                ...
                auto_anon_in_a_bits_size,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  ...
  output [2:0]  auto_anon_in_d_bits_opcode,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                auto_anon_in_d_bits_size,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  ...
  wire [2:0]  _dFirst_size_T_8 =
    {1'h0, dFirst_size_hi[2:1]} | ~(_dsizeOH1_T[2:0]) & {_GEN[0], _dsizeOH1_T[2:1]};	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, generators/rocket-chip/src/main/scala/util/package.scala:241:{47,49}, :243:{46,71,76}, src/main/scala/chisel3/util/OneHot.scala:30:18, :31:18, :32:28
  wire [2:0]  dFirst_size =
    {|dFirst_size_hi,
     |(_dFirst_size_T_8[2:1]),
     _dFirst_size_T_8[2] | _dFirst_size_T_8[0]};	// generators/rocket-chip/src/main/scala/util/package.scala:241:47, src/main/scala/chisel3/util/OneHot.scala:30:18, :31:18, :32:{10,14,28}
  wire        drop =
    ~(auto_anon_out_d_bits_opcode[0]) & (|(auto_anon_out_d_bits_source[2:0]));	// generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:204:41, :206:30, :234:{20,30}
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
    ...
    automatic logic _GEN_1;	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :220:27, :222:25, :223:19
    _GEN_0 = anonOut_d_ready & auto_anon_out_d_valid;	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:235:35, src/main/scala/chisel3/util/Decoupled.scala:51:35
    _GEN_1 = _GEN_0 & dFirst;	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :205:29, :220:27, :222:25, :223:19, src/main/scala/chisel3/util/Decoupled.scala:51:35
    if (reset) begin	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
      ...
      if (_GEN_0) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
        if (dFirst)	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:205:29
          ...
          acknum <=
            acknum
            - {2'h0, auto_anon_out_d_bits_opcode[0] | (&auto_anon_out_d_bits_size)};	// generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29, :216:{32,56}, :221:55, src/main/scala/chisel3/util/OneHot.scala:65:12
      end
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
    ...
    initial begin	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
      automatic logic [31:0] _RANDOM[0:0];	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
  ...
  assign auto_anon_out_a_bits_size =
    _repeater_io_deq_bits_size[2] ? 2'h3 : _repeater_io_deq_bits_size[1:0];	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :297:{24,31}, src/main/scala/chisel3/util/OneHot.scala:65:12
  assign auto_anon_out_a_bits_source =
    {_repeater_io_deq_bits_source, ~(aFirst ? dToggle : aToggle_r), aFragnum};	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :203:30, :274:30, :304:29, :305:30, :309:{23,27,54}, :317:33
  assign auto_anon_out_a_bits_address =
    {_repeater_io_deq_bits_address[27:6],
     _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:243:{71,76}
