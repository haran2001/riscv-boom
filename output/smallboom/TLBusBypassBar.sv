...
module TLBusBypassBar(	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
  input          clock,	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
                 reset,	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
  ...
  input  [1:0]   auto_out_1_d_bits_param,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                 auto_out_1_d_bits_size,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  input          auto_out_1_d_bits_source,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                 auto_out_1_d_bits_sink,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                 auto_out_1_d_bits_denied,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  ...
  input          auto_out_1_d_bits_corrupt,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                 auto_out_0_a_ready,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  ...
  input          auto_out_0_d_bits_denied,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
                 auto_out_0_d_bits_corrupt,	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25
  ...
  wire [2:0] nodeIn_d_bits_opcode =
    bypass ? auto_out_0_d_bits_opcode : auto_out_1_d_bits_opcode;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21
  wire [1:0] nodeIn_d_bits_param = bypass ? 2'h0 : auto_out_1_d_bits_param;	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21
  wire [1:0] nodeIn_d_bits_size =
    bypass ? auto_out_0_d_bits_size : auto_out_1_d_bits_size;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21
  ...
  wire       nodeIn_d_bits_denied =
    bypass ? auto_out_0_d_bits_denied : auto_out_1_d_bits_denied;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21
  wire       nodeIn_d_bits_corrupt =
    bypass ? auto_out_0_d_bits_corrupt : auto_out_1_d_bits_corrupt;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
    automatic logic       r_3;	// src/main/scala/chisel3/util/Decoupled.scala:51:35
    automatic logic       d_dec;	// src/main/scala/chisel3/util/Decoupled.scala:51:35
    automatic logic [1:0] _next_flight_T_10;	// generators/rocket-chip/src/main/scala/tilelink/Edges.scala:324:46
    r_3 = nodeIn_a_ready & auto_in_a_valid;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:90:28, src/main/scala/chisel3/util/Decoupled.scala:51:35
    d_dec = auto_in_d_ready & nodeIn_d_valid;	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:96:24, src/main/scala/chisel3/util/Decoupled.scala:51:35
    _next_flight_T_10 =
      flight
      + {1'h0,
         d_dec & ~r_counter_3 & nodeIn_d_bits_opcode[2] & ~(nodeIn_d_bits_opcode[1])}
      + {1'h0, r_3 & ~r_counter} - {1'h0, d_dec};	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9, :98:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:71:{36,43,52}, :229:27, :231:25, :295:25, :310:26, :313:37, :324:{30,40,46}, src/main/scala/chisel3/util/Decoupled.scala:51:35
    if (reset) begin	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
      ...
      flight <= 2'h0;	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:295:25
    ...
    if (in_reset | _next_flight_T_10 == 2'h0)	// generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:106:25, generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:79:27, :85:{20,36}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:324:46
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
    ...
    initial begin	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
      automatic logic [31:0] _RANDOM[0:0];	// generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9
