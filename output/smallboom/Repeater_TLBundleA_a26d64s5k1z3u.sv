...
module Repeater_TLBundleA_a26d64s5k1z3u(	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
  input         clock,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
                reset,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
                io_repeat,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
  output        io_full,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_enq_ready,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
  ...
  input  [2:0]  io_enq_bits_opcode,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_enq_bits_param,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_enq_bits_size,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
  ...
  input         io_enq_bits_corrupt,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_deq_ready,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
  ...
  output [2:0]  io_deq_bits_opcode,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_deq_bits_param,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
                io_deq_bits_size,	// generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
    automatic logic _GEN;	// generators/rocket-chip/src/main/scala/util/Repeater.scala:29:21
    _GEN = io_enq_ready_0 & io_enq_valid & io_repeat;	// generators/rocket-chip/src/main/scala/util/Repeater.scala:25:32, :29:21
    if (reset)	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
      ...
      full <= ~(io_deq_ready & io_deq_valid_0 & ~io_repeat) & (_GEN | full);	// generators/rocket-chip/src/main/scala/util/Repeater.scala:20:21, :24:32, :29:{21,36,43}, :30:{21,24,36,43}
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
      automatic logic [31:0] _RANDOM[0:3];	// generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7
