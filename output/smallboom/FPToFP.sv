...
module FPToFP(	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
  input         clock,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
                reset,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
                io_in_valid,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:574:14
                io_in_bits_ren2,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:574:14
  ...
  input  [64:0] io_in_bits_in1,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:574:14
                io_in_bits_in2,	// generators/rocket-chip/src/main/scala/tile/FPU.scala:574:14
    ...
    _GEN
      ...
      : in_pipe_b_wflags
          ...
          : {in_pipe_b_rm[1]
             ...
             in_pipe_b_in1[63:0]};	// generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :582:{20,31,48,66,77}, :583:{18,45}, :587:17, :589:25, :593:27, :594:{24,41,51,54}, :596:{19,25,53}, :608:{24,42}, :611:24, :612:21, src/main/scala/chisel3/util/Valid.scala:142:26
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
    ...
    if (in_pipe_v) begin	// src/main/scala/chisel3/util/Valid.scala:141:24
      automatic logic       _GEN_0;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:603:18
      automatic logic [8:0] _mux_data_expOut_commonCase_T = fsgnjMux_data[60:52] - 9'h100;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:276:18, :280:31, :589:25, :608:42, :612:21
      _GEN_0 = in_pipe_b_typeTagOut == 2'h0;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:603:18, src/main/scala/chisel3/util/Valid.scala:142:26
      io_out_pipe_b_data <=
        _GEN_0
          ? (_GEN
               ...
               : {fsgnjMux_data[64:33],
                  ...
                  fsgnjMux_data[51:29]})
          : fsgnjMux_data;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:274:17, :276:18, :277:38, :279:26, :280:{31,50}, :281:{10,19,27,38,49,69}, :589:25, :601:24, :603:{18,36}, :604:{16,22,37}, :608:{24,42}, :612:21, :618:126, :619:30, :624:{18,24,39}, src/main/scala/chisel3/util/Valid.scala:142:26
      io_out_pipe_b_exc <=
        _GEN & _GEN_0
          ...
          : _GEN
              ...
              : in_pipe_b_wflags
                  ? {(&(in_pipe_b_in1[63:61])) & ~(in_pipe_b_in1[51])
                     ...
                     4'h0}
                  : 5'h0;	// generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :250:{34,37,39}, :573:7, :586:16, :589:25, :592:49, :595:{18,31}, :601:24, :603:18, :608:{24,42}, :613:{20,51}, :618:126, :619:30, :625:17, src/main/scala/chisel3/util/Valid.scala:142:26
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
      automatic logic [31:0] _RANDOM[0:13];	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7
        ...
        io_out_pipe_pipe_b_data =
          {_RANDOM[4'h9][31:8], _RANDOM[4'hA], _RANDOM[4'hB][8:0]};	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26
        ...
        io_out_pipe_pipe_pipe_b_data =
          {_RANDOM[4'hB][31:15], _RANDOM[4'hC], _RANDOM[4'hD][15:0]};	// generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26
