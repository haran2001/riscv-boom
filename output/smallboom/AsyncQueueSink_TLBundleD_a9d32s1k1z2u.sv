...
module AsyncQueueSink_TLBundleD_a9d32s1k1z2u(	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
  input         clock,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
                reset,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
                io_deq_ready,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
  ...
  output [1:0]  io_deq_bits_param,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
                io_deq_bits_size,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
  output        io_deq_bits_source,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
                io_deq_bits_sink,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
                io_deq_bits_denied,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
  ...
  input         io_async_safe_widx_valid,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
                io_async_safe_source_reset_n,	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:139:14
  ...
  wire        ridx =
    _source_valid_io_out & ridx_ridx_bin + (io_deq_ready & io_deq_valid_0);	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:{23,43}, :166:29, :176:31, src/main/scala/chisel3/util/Decoupled.scala:51:35
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
    ...
    initial begin	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
      automatic logic [31:0] _RANDOM[0:0];	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7
  ...
  ClockCrossingReg_w43 io_deq_bits_deq_bits_reg (	// generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25
    ...
    .io_d
      ({io_async_mem_0_opcode,
        ...
        2'h0,
        io_async_mem_0_data,
        1'h0}),	// generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:136:7, :139:14, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:24
