...
module RoundAnyRawFNToRecFN_ie11_is53_oe8_os24(	// generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5
      ...
      ? (_roundMask_T_1[7]
           ...
           : {22'h0,
              _roundMask_T_1[6]
                ...
                : 3'h0})
      : 25'h0;	// generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:58:16, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:52:21, :58:25, :59:26, :62:24, :67:24, :68:58, :73:{17,21,32}, :76:56, :77:20, :78:22
  ...
  wire [25:0] roundedSig =
    _overflow_roundMagUp_T & (|_roundPosBit_T) | roundMagUp & anyRound
      ? {1'h0, io_in_sig[53:29] | _roundMask_T_74} + 26'h1
        & ~(roundingMode_near_even & (|_roundPosBit_T) & ~(|_anyRoundExtra_T)
              ? {_roundMask_T_74, 1'h1}
              : 26'h0)
      : {1'h0, io_in_sig[53:29] & ~_roundMask_T_74}
    ...
    {io_invalidExc,
     ...
     commonCase
       & (common_totalUnderflow | anyRound & $signed(sAdjustedExp[13:8]) < 6'sh1
          & _roundMask_T_74[0]
          & ~(~(_roundMask_T_74[1]) & roundedSig[24] & (|_roundPosBit_T)
