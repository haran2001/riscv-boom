...
module TLError(	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
  input         clock,	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
                reset,	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
  ...
  wire [8:0]      a_last_beats1 =
    _a_q_io_deq_bits_opcode[2] ? 9'h0 : ~(_a_last_beats1_decode_T[11:3]);	// generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21
  ...
  wire            _q_io_deq_ready_T_3 =
    auto_in_d_ready & (r_counter == 9'h1 | r_beats1 == 9'h0) | ~a_last;	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:{26,46,49}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}
  ...
  `ifdef ENABLE_INITIAL_REG_	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
    ...
    initial begin	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
      automatic logic [31:0] _RANDOM[0:0];	// generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9
