...
module Queue8_BundleMap_4(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  input  [6:0] io_enq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input  [2:0] io_enq_bits_extra_id,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  input        io_deq_ready,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output       io_deq_valid,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [3:0] io_deq_bits_tl_state_size,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [6:0] io_deq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:255:14
  output [2:0] io_deq_bits_extra_id	// src/main/scala/chisel3/util/Decoupled.scala:255:14
);
  ...
  ram_8x14 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_enq_bits_extra_id, io_enq_bits_tl_state_source, io_enq_bits_tl_state_size})	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  );
  ...
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[10:4];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_extra_id = _ram_ext_R0_data[13:11];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
