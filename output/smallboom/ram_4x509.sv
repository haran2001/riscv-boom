...
module ram_4x509(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  output [508:0] R0_data,
  input  [1:0]   W0_addr,
  input          W0_en,
                 W0_clk,
  input  [508:0] W0_data
  ...
  reg [508:0] Memory[0:3];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          ...
          Memory[i[1:0]] = _RANDOM_MEM[508:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        end	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 509'bx;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
endmodule
