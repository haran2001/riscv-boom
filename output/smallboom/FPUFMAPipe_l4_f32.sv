    ...
    if (io_in_valid) begin	// generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14
      ...
      in_in3 <=
        io_in_bits_ren3 | io_in_bits_swap23
          ? io_in_bits_in3
          : {32'h0, (io_in_bits_in1[32:0] ^ io_in_bits_in2[32:0]) & 33'h100000000};	// generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14, :708:15, :711:{32,50,57}, :714:8, :716:{21,37,46}
    end
