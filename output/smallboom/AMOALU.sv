...
module AMOALU(	// generators/rocket-chip/src/main/scala/rocket/AMOALU.scala:54:7
  ...
  wire [63:0] wmask =
    {{8{io_mask[7]}},
     ...
     {8{io_mask[2]}},
     {8{io_mask[1]}},
     {8{io_mask[0]}}};	// generators/rocket-chip/src/main/scala/rocket/AMOALU.scala:75:69, :94:49, :106:30
  assign io_out =
    wmask
    & (io_cmd == 5'h8
