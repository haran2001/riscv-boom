...
module TLFragmenter_bootrom(	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
  ...
  always @(posedge clock) begin	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9
    ...
    _GEN_0 = auto_anon_in_d_ready & auto_anon_out_d_valid;	// src/main/scala/chisel3/util/Decoupled.scala:51:35
  ...
  assign auto_anon_out_a_bits_size =
    _repeater_io_deq_bits_size[2] ? 2'h3 : _repeater_io_deq_bits_size[1:0];	// generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :297:{24,31}
